-- Скрипт сгенерирован Devart dbForge Studio for MySQL, Версия 4.50.339.1
-- Дата: 08.03.2011 20:26:36
-- Версия сервера: 5.1.56-community
-- Версия клиента: 4.1
...
--
-- Описание для таблицы applicant_bad_code
--
DROP TABLE IF EXISTS applicant_bad_code;
CREATE TABLE applicant_bad_code (
...
--
DROP TABLE IF EXISTS cattell_query;
CREATE TABLE cattell_query (
  number SMALLINT(6) UNSIGNED NOT NULL COMMENT 'порядковый номер',
  ...
  score_1 TINYINT(4) UNSIGNED NOT NULL COMMENT 'баллы за 1-й вариант ответа',
  score_2 TINYINT(4) NOT NULL COMMENT 'баллы за 2-й вариант ответа',
  score_3 TINYINT(4) NOT NULL COMMENT 'баллы за 3-й вариант ответа',
  score_1_md TINYINT(4) NOT NULL COMMENT 'баллы фактор md 1-й вариант ответа',
  score_3_md TINYINT(4) UNSIGNED NOT NULL COMMENT 'баллы фактор md 3-й вариант ответа',
  score_1_fb TINYINT(4) UNSIGNED NOT NULL COMMENT 'баллы фактор fb 1-й вариант ответа',
  score_3_fb TINYINT(4) UNSIGNED NOT NULL COMMENT 'баллы фактор fb 3-й вариант ответа',
  answer_code SMALLINT(6) UNSIGNED DEFAULT NULL COMMENT 'код варианта ответа',
...
--
DROP TABLE IF EXISTS cattell_sten;
CREATE TABLE cattell_sten (
  number SMALLINT(6) UNSIGNED NOT NULL COMMENT 'бесполезный код',
  sex TINYINT(2) UNSIGNED NOT NULL COMMENT 'пол',
  age_min SMALLINT(6) UNSIGNED NOT NULL COMMENT 'минимальный возраст',
  age_max SMALLINT(6) UNSIGNED NOT NULL COMMENT 'максимальный возраст',
  factor VARCHAR(2) NOT NULL COMMENT 'фактор',
  sten1 SMALLINT(6) NOT NULL COMMENT 'максимальная граница возраста',
  sten2 SMALLINT(6) NOT NULL COMMENT 'максимальная граница возраста',
  sten3 SMALLINT(6) NOT NULL COMMENT 'максимальная граница возраста',
  sten4 SMALLINT(6) NOT NULL COMMENT 'максимальная граница возраста',
  sten5 SMALLINT(6) NOT NULL COMMENT 'максимальная граница возраста',
  sten6 SMALLINT(6) NOT NULL COMMENT 'максимальная граница возраста',
  sten7 SMALLINT(6) NOT NULL COMMENT 'максимальная граница возраста',
  sten8 SMALLINT(6) NOT NULL COMMENT 'максимальная граница возраста',
  sten9 SMALLINT(6) NOT NULL COMMENT 'максимальная граница возраста'
)
ENGINE = INNODB
CHARACTER SET utf8
COLLATE utf8_general_ci
...
--
DROP TABLE IF EXISTS cattell_text;
CREATE TABLE cattell_text (
  factor VARCHAR(5) DEFAULT NULL COMMENT 'фактор',
  `group` SMALLINT(6) DEFAULT NULL COMMENT 'группа фактора',
  min SMALLINT(6) DEFAULT NULL COMMENT 'минимальное значение фактора',
  max SMALLINT(6) DEFAULT NULL COMMENT 'максимальное значение фактора',
...
--
DROP TABLE IF EXISTS contact_method_code;
CREATE TABLE contact_method_code (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
DROP TABLE IF EXISTS criterion_code;
CREATE TABLE criterion_code (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ключевое поле',
...
--
DROP TABLE IF EXISTS customer_bad_code;
CREATE TABLE customer_bad_code (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
DROP TABLE IF EXISTS family_code;
...
--
DROP TABLE IF EXISTS formation_code;
...
--
DROP TABLE IF EXISTS housing_code;
CREATE TABLE housing_code (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
DROP TABLE IF EXISTS locus_query;
CREATE TABLE locus_query (
  number SMALLINT(6) NOT NULL COMMENT 'порядковый номер сравнения',
  statement_1 VARCHAR(120) NOT NULL COMMENT 'Экстернальность',
  code_1 SMALLINT(6) NOT NULL COMMENT 'код Экстернальность',
  statement_2 VARCHAR(120) NOT NULL COMMENT 'Интернальность',
  code_2 SMALLINT(6) NOT NULL COMMENT 'код Интернальность',
  answer_code SMALLINT(6) DEFAULT NULL COMMENT 'код выбранного утверждения',
...
--
DROP TABLE IF EXISTS need_query;
CREATE TABLE need_query (
  number SMALLINT(6) NOT NULL COMMENT 'порядковый номер сравнения',
  statement_1 VARCHAR(60) NOT NULL COMMENT '1-е утверждение',
  code_1 SMALLINT(6) NOT NULL COMMENT 'код 1-го утверждения',
  statement_2 VARCHAR(60) NOT NULL COMMENT '2-е утверждение',
  code_2 SMALLINT(6) NOT NULL COMMENT 'код 2-го утверждения',
  answer_code SMALLINT(6) DEFAULT NULL COMMENT 'код выбранного утверждения',
  answer_view VARCHAR(1) DEFAULT NULL COMMENT 'а) или б) для обработки оператором'
)
ENGINE = INNODB
...
--
DROP TABLE IF EXISTS placement_close_code;
CREATE TABLE placement_close_code (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
DROP TABLE IF EXISTS profession_book;
CREATE TABLE profession_book (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  name VARCHAR(64) NOT NULL COMMENT 'название профессии',
  parent INT(11) NOT NULL COMMENT 'код родителя',
  folder TINYINT(4) NOT NULL COMMENT 'индикатор папки',
  PRIMARY KEY (code)
)
ENGINE = INNODB
CHARACTER SET utf8
...
CREATE TABLE program_book (
  ...
  parent INT(11) NOT NULL COMMENT 'код родителя',
  folder TINYINT(4) NOT NULL COMMENT 'флаг папки',
  PRIMARY KEY (code)
)
ENGINE = INNODB
CHARACTER SET utf8
...
CREATE TABLE psychology (
  ...
  sex TINYINT(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'пол',
  iq TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'интеллект',
  a_ TINYINT(3) DEFAULT NULL COMMENT 'общительность (без коррекции)',
  a TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'общительность',
  b TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'способность к обучению',
  c_ TINYINT(3) DEFAULT NULL COMMENT 'эмоциональная устойчивость (без коррекции)',
  c TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'эмоциональная устойчивость',
  e TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'властность',
  f_ TINYINT(3) DEFAULT NULL COMMENT 'импульсивность (без коррекции)',
  f TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'импульсивность',
  g TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'дисциплинированность',
  h_ TINYINT(3) DEFAULT NULL COMMENT 'социальная смелость (без коррекции)',
  h TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'социальная смелость',
  i TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'чувствительност',
  l_ TINYINT(3) DEFAULT NULL COMMENT 'подозрительность (без коррекции)',
  l TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'подозрительность',
  m TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'творческий потенциал',
  n TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'проницательность',
  o_ TINYINT(3) DEFAULT NULL COMMENT 'неуверенность в себе (без коррекции)',
  o TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'неуверенность в себе',
  q1 TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'новаторство',
  q2_ TINYINT(3) DEFAULT NULL COMMENT 'самодостаточность (без коррекции)',
  q2 TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'самодостаточность',
  q3 TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'самоконтроль',
  q4_ TINYINT(3) DEFAULT NULL COMMENT 'напряжённость (без коррекции)',
  q4 TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'напряжённость',
  md TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'самооценка',
  ft TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'тревожность',
  fe TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'экстровертность',
  fb TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'ложь',
  time_kettell SMALLINT(5) UNSIGNED DEFAULT NULL COMMENT 'время тестирования Кеттелл',
  personalities TEXT DEFAULT NULL COMMENT 'свойства личности',
  conclusion TEXT DEFAULT NULL COMMENT 'профзаключение',
  recommendation TEXT DEFAULT NULL COMMENT 'рекомендации',
  material TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'материальные (парные сравнения)',
  safety TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'безопасность (парные сравнения)',
  socia TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'социальные (парные сравнения)',
  confession TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'признание (парные сравнения)',
  express TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'самовыражение (парные сравнения)',
  time_need SMALLINT(5) UNSIGNED DEFAULT NULL COMMENT 'время тест парных сравнений',
  contend TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'соперничество (Томас)',
  cooperate TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'сотрудничество (Томас)',
  compromise TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'компромисс (Томас)',
  adapt TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'приспособление (Томас)',
  avoid TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'избегание (Томас)',
  time_tomas SMALLINT(5) UNSIGNED DEFAULT NULL COMMENT 'время (Томас)',
  lk TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'локус контроля',
  time_locus SMALLINT(5) UNSIGNED DEFAULT NULL COMMENT 'время Локус контроля',
  time_all SMALLINT(5) DEFAULT NULL COMMENT 'общее время тестирования',
...
--
DROP TABLE IF EXISTS recruit_deflect_code;
CREATE TABLE recruit_deflect_code (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
DROP TABLE IF EXISTS speciality_book;
CREATE TABLE speciality_book (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
DROP TABLE IF EXISTS tomas_query;
CREATE TABLE tomas_query (
  number SMALLINT(6) NOT NULL COMMENT 'порядковый номер сравнения',
...
CREATE TABLE user (
  ...
  access TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'тип доступа',
  block TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'флаг блокировка доступа',
  deleted TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'флаг удаление пользователя',
  PRIMARY KEY (code),
...
CREATE TABLE applicant (
  ...
  sex TINYINT(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'пол',
  date_registration DATETIME DEFAULT NULL COMMENT 'дата регистрации',
  crime TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'криминальная проверка',
  date_update DATETIME DEFAULT NULL COMMENT 'дата актуализации',
  photo MEDIUMBLOB DEFAULT NULL COMMENT 'фото',
  growing TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'рост',
  weight TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'вес',
  smoking TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'курение',
  chronic VARCHAR(60) DEFAULT NULL COMMENT 'хронические заболевания',
  address VARCHAR(90) DEFAULT NULL COMMENT 'адрес проживания',
  region INT(10) UNSIGNED DEFAULT NULL COMMENT 'район проживания',
  housing INT(10) UNSIGNED DEFAULT NULL COMMENT 'условия проживания',
  family INT(10) UNSIGNED DEFAULT NULL COMMENT 'семейное положение',
  passport VARCHAR(120) DEFAULT NULL COMMENT 'паспорт',
  check_passport TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'сверка паспорта',
  ...
  formation INT(10) UNSIGNED DEFAULT NULL COMMENT 'образование',
  a_category TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'водительское удостоверение категория A',
  b_category TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'водительское удостоверение категория B',
  c_category TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'водительское удостоверение категория С',
  d_category TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'водительское удостоверение категория D',
  e_category TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'водительское удостоверение категория E',
  car VARCHAR(40) DEFAULT NULL COMMENT 'марка личного автомобиля',
  year_car YEAR(4) DEFAULT NULL COMMENT 'год выпуска автомобиля',
  use_car TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'служебное использование автомобиля',
  ...
  salary_last INT(10) UNSIGNED DEFAULT NULL COMMENT 'зарплата на последней работе',
  salary_desired INT(10) UNSIGNED DEFAULT NULL COMMENT 'желаемая зарплата',
  date_salary DATETIME DEFAULT NULL COMMENT 'дата обновления желаемой зарплаты',
  income INT(10) UNSIGNED DEFAULT NULL COMMENT 'средний доход на члена семьи',
  overtime TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'сверхурочная работа',
  trip TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'командировки',
  region_city TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'работа в любом районе города',
  city TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'работа в любом городе',
  employed TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'трудоустроен',
  date_warranty DATETIME DEFAULT NULL COMMENT 'конец испытательного срока',
  expert INT(10) UNSIGNED DEFAULT NULL COMMENT 'эксперт по профессии',
  date_back DATETIME DEFAULT NULL COMMENT 'с какой даты предлагать работу',
  bad INT(10) UNSIGNED DEFAULT NULL COMMENT 'черный список',
  ...
  iq TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология IQ',
  a TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор A',
  b TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор B',
  c TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор C',
  e TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор E',
  f TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор F',
  g TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор G',
  h TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор H',
  i TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор I',
  l TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор L',
  m TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор M',
  n TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор N',
  o TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор O',
  q1 TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор Q1',
  q2 TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор Q2',
  q3 TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор Q3',
  q4 TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор Q4',
  md TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор MD',
  ft TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор FT',
  fe TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор FE',
  fb TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор FB',
  lk TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология локус контроля',
  ...
  material TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'Материальные',
  safety TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'Безопасность',
  socia TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'Социальные',
  confession TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'Признание',
  express TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'Самовыражение',
  contend TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'Соперничество',
  cooperate TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'Сотрудничество',
  compromise TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'Компромисс',
  adapt TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'Приспособление',
  avoid TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'Избегание',
  kettell_time SMALLINT(5) UNSIGNED DEFAULT NULL COMMENT 'время тестирования Кеттелл',
  need_time SMALLINT(5) UNSIGNED DEFAULT NULL COMMENT 'время тестирования Парные сравнения',
  tomas_time SMALLINT(5) UNSIGNED DEFAULT NULL COMMENT 'время тестирования Томас',
  locus_time SMALLINT(5) UNSIGNED DEFAULT NULL COMMENT 'время тестирования Локус контроля',
...
--
DROP TABLE IF EXISTS criterion_query;
CREATE TABLE criterion_query (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  criterion INT(10) UNSIGNED DEFAULT NULL COMMENT 'код критерия',
  question VARCHAR(255) DEFAULT NULL COMMENT 'вопрос',
  note VARCHAR(255) DEFAULT NULL COMMENT 'пояснения',
  score TINYINT(4) DEFAULT NULL COMMENT 'оценка',
  PRIMARY KEY (code),
...
CREATE TABLE customer (
  ...
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  date_update DATETIME DEFAULT NULL COMMENT 'дата актуализации',
  consultant INT(10) UNSIGNED DEFAULT NULL COMMENT 'куратор',
  type INT(10) UNSIGNED DEFAULT NULL COMMENT 'класс клиента',
  bad INT(10) UNSIGNED DEFAULT NULL COMMENT 'черный список',
  ...
  business INT(10) UNSIGNED DEFAULT NULL COMMENT 'сфера деятельности',
...
CREATE TABLE profile (
  ...
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  expert_count INT(10) UNSIGNED DEFAULT NULL,
  avg_a TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор A - среднее',
  std_a TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'психология Кеттелл фактор A - отклонение',
  avg_b TINYINT(3) UNSIGNED DEFAULT NULL,
  std_b TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_c TINYINT(3) UNSIGNED DEFAULT NULL,
  std_c TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_e TINYINT(3) UNSIGNED DEFAULT NULL,
  std_e TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_f TINYINT(3) UNSIGNED DEFAULT NULL,
  std_f TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_g TINYINT(3) UNSIGNED DEFAULT NULL,
  std_g TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_h TINYINT(3) UNSIGNED DEFAULT NULL,
  std_h TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_i TINYINT(3) UNSIGNED DEFAULT NULL,
  std_i TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_l TINYINT(3) UNSIGNED DEFAULT NULL,
  std_l TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_m TINYINT(3) UNSIGNED DEFAULT NULL,
  std_m TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_n TINYINT(3) UNSIGNED DEFAULT NULL,
  std_n TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_o TINYINT(3) UNSIGNED DEFAULT NULL,
  std_o TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_q1 TINYINT(3) UNSIGNED DEFAULT NULL,
  std_q1 TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_q2 TINYINT(3) UNSIGNED DEFAULT NULL,
  std_q2 TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_q3 TINYINT(3) UNSIGNED DEFAULT NULL,
  std_q3 TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_q4 TINYINT(3) UNSIGNED DEFAULT NULL,
  std_q4 TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_md TINYINT(3) UNSIGNED DEFAULT NULL,
  std_md TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_ft TINYINT(3) UNSIGNED DEFAULT NULL,
  std_ft TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_fe TINYINT(3) UNSIGNED DEFAULT NULL,
  std_fe TINYINT(3) UNSIGNED DEFAULT NULL,
  avg_lk TINYINT(3) UNSIGNED DEFAULT NULL,
  std_lk TINYINT(3) UNSIGNED DEFAULT NULL,
  PRIMARY KEY (code),
...
CREATE TABLE career (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  applicant INT(10) UNSIGNED DEFAULT NULL COMMENT 'код соискателя',
  ...
  business INT(10) UNSIGNED DEFAULT NULL COMMENT 'сфера деятельности организации',
  ...
  checked TINYINT(3) NOT NULL DEFAULT 0 COMMENT 'проверено',
  PRIMARY KEY (code),
  INDEX business (business),
...
CREATE TABLE children (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  applicant INT(10) UNSIGNED NOT NULL COMMENT 'код соискателя',
...
--
DROP TABLE IF EXISTS education_add;
CREATE TABLE education_add (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  applicant INT(10) UNSIGNED DEFAULT NULL COMMENT 'код соискателя',
...
--
DROP TABLE IF EXISTS education_base;
CREATE TABLE education_base (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  applicant INT(10) UNSIGNED DEFAULT NULL COMMENT 'код соискателя',
  ...
  city VARCHAR(30) DEFAULT NULL COMMENT 'город',
  type INT(10) UNSIGNED DEFAULT NULL COMMENT 'тип обучения',
  speciality INT(10) UNSIGNED DEFAULT NULL COMMENT 'специальность',
  specialization VARCHAR(80) DEFAULT NULL COMMENT 'специализация',
  PRIMARY KEY (code),
  INDEX recruit (applicant),
...
CREATE TABLE language (
  ...
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  applicant INT(10) UNSIGNED DEFAULT NULL COMMENT 'код соискателя',
  language INT(10) UNSIGNED DEFAULT NULL COMMENT 'код языка',
  level INT(10) UNSIGNED DEFAULT NULL COMMENT 'уровень владения',
  PRIMARY KEY (code),
...
CREATE TABLE marketing (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  customer INT(10) UNSIGNED DEFAULT NULL COMMENT 'код заказчика',
  date_contact DATETIME DEFAULT NULL COMMENT 'дата контакта',
  method INT(10) UNSIGNED DEFAULT NULL COMMENT 'способ контакта: e-mail, звонок письмо ...',
  consultant INT(10) UNSIGNED DEFAULT NULL COMMENT 'код консультанта',
  type INT(10) UNSIGNED DEFAULT NULL COMMENT 'тип контакта: КП, сделка, презентация ...',
...
CREATE TABLE placement (
  code INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'уникальный код заказа',
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'TIMESTAMP',
  customer INT(10) UNSIGNED DEFAULT NULL COMMENT 'код заказчика',
  date_registration DATETIME DEFAULT NULL COMMENT 'дата регистрации',
  ...
  price INT(10) UNSIGNED DEFAULT NULL COMMENT 'стоимость подбра',
  credit TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'подбор в кредит',
  free TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'бесплатный подбор',
  warranty TINYINT(3) UNSIGNED DEFAULT NULL COMMENT 'гарантия в месяцах',
  ...
  reason_close INT(10) UNSIGNED DEFAULT NULL COMMENT 'причина закрытия',
...
CREATE TABLE profession (
  ...
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  applicant INT(10) UNSIGNED DEFAULT NULL COMMENT 'код соискателя',
  profession INT(10) UNSIGNED DEFAULT NULL COMMENT 'код профессии',
  PRIMARY KEY (code),
...
CREATE TABLE program (
  ...
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  applicant INT(10) UNSIGNED DEFAULT NULL COMMENT 'код соискателя',
  program INT(10) UNSIGNED DEFAULT NULL COMMENT 'код программы',
  level INT(10) UNSIGNED DEFAULT NULL COMMENT 'уровень владения программой',
  PRIMARY KEY (code),
  INDEX level (level),
...
CREATE TABLE review (
  ...
  consultant INT(10) UNSIGNED DEFAULT NULL COMMENT 'код пользователя',
...
CREATE TABLE criterion (
  ...
  criterion INT(10) UNSIGNED DEFAULT NULL,
  PRIMARY KEY (code),
  INDEX criterion (criterion),
...
CREATE TABLE history (
  ...
  ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  applicant INT(10) UNSIGNED DEFAULT NULL COMMENT 'код соискателя',
  placement INT(10) UNSIGNED DEFAULT NULL COMMENT 'номер заказа',
  ...
  deflect INT(10) UNSIGNED DEFAULT NULL COMMENT 'причина отклонения',
  detal TEXT DEFAULT NULL COMMENT 'оченки по критериям',
  average FLOAT(2, 1) DEFAULT NULL COMMENT 'средняя оценка',
  note VARCHAR(255) DEFAULT NULL COMMENT 'примечание',
  marker TINYINT(4) NOT NULL DEFAULT 0 COMMENT 'маркер обработки',
  PRIMARY KEY (code),
...
--
DROP PROCEDURE IF EXISTS applicant_back$$
...
--
DROP PROCEDURE IF EXISTS calc_profile$$
...
--
DROP FUNCTION IF EXISTS factor_score$$
...
--
DROP FUNCTION IF EXISTS md_sten$$
...
--
DROP FUNCTION IF EXISTS time_work$$
...
--
DROP FUNCTION IF EXISTS year_noun$$
...
INSERT INTO speciality_book VALUES 
  (1, '0000-00-00 00:00:00', '(010000) ФИЗИКО-МАТЕМАТИЧЕСКИЕ НАУКИ', 1000, 1),
  (2, '0000-00-00 00:00:00', '(010100) Математика', 1, 1),
  (3, '0000-00-00 00:00:00', '(010101) Математика', 2, 0),
  (4, '0000-00-00 00:00:00', '(010200) Математика. Прикладная математика', 1, 0),
  (5, '0000-00-00 00:00:00', '(010300) Математика. Компьютерные науки', 1, 0),
  (6, '0000-00-00 00:00:00', '(010400) Информационные технологии', 1, 0),
  (7, '0000-00-00 00:00:00', '(010500) Прикладная математика и информатика', 1, 1),
  (8, '0000-00-00 00:00:00', '(010501) Прикладная математика и информатика', 7, 0),
  (9, '0000-00-00 00:00:00', '(010503) Математическое обеспечение и администрирование информационных систем', 7, 0),
  (10, '0000-00-00 00:00:00', '(010600) Прикладные математика и физика', 1, 0),
  (11, '0000-00-00 00:00:00', '(010700) Физика', 1, 1),
  (12, '0000-00-00 00:00:00', '(010701) Физика', 11, 0),
  (13, '0000-00-00 00:00:00', '(010702) Астрономия', 11, 0),
  (14, '0000-00-00 00:00:00', '(010703) Физика Земли и планет', 11, 0),
  (15, '0000-00-00 00:00:00', '(010704) Физика конденсированного состояния вещества', 11, 0),
  (16, '0000-00-00 00:00:00', '(010705) Физика атомного ядра и частиц', 11, 0),
  (17, '0000-00-00 00:00:00', '(010706) Физика кинетических явлений', 11, 0),
  (18, '0000-00-00 00:00:00', '(010707) Медицинская физика', 11, 0),
  (19, '0000-00-00 00:00:00', '(010708) Биохимическая физика', 11, 0),
  (20, '0000-00-00 00:00:00', '(010710) Физика открытых нелинейных систем', 11, 0),
  (21, '0000-00-00 00:00:00', '(010800) Радиофизика', 1, 1),
  (22, '0000-00-00 00:00:00', '(010801) Радиофизика и электроника', 21, 0),
  (23, '0000-00-00 00:00:00', '(010802) Фундаментальная радиофизика и физическая электроника', 21, 0),
  (24, '0000-00-00 00:00:00', '(010803) Микроэлектроника и полупроводниковые приборы', 21, 0),
  (25, '0000-00-00 00:00:00', '(010900) Механика', 1, 1),
  (26, '0000-00-00 00:00:00', '(010901) Механика', 25, 0),
  (27, '0000-00-00 00:00:00', '(011000) Механика. Прикладная математика', 1, 0),
  (28, '0000-00-00 00:00:00', '(020000) ЕСТЕСТВЕННЫЕ НАУКИ', 1000, 1),
  (29, '0000-00-00 00:00:00', '(020100) Химия', 28, 1),
  (30, '0000-00-00 00:00:00', '(020101) Химия', 29, 0),
  (31, '0000-00-00 00:00:00', '(020200) Биология', 28, 1),
  (32, '0000-00-00 00:00:00', '(020201) Биология', 31, 0),
  (33, '0000-00-00 00:00:00', '(020202) Антропология', 31, 0),
  (34, '0000-00-00 00:00:00', '(020203) Зоология', 31, 0),
  (35, '0000-00-00 00:00:00', '(020204) Ботаника', 31, 0),
  (36, '0000-00-00 00:00:00', '(020205) Физиология', 31, 0),
  (37, '0000-00-00 00:00:00', '(020206) Генетика', 31, 0),
  (38, '0000-00-00 00:00:00', '(020207) Биофизика', 31, 0),
  (39, '0000-00-00 00:00:00', '(020208) Биохимия', 31, 0),
  (40, '0000-00-00 00:00:00', '(020209) Микробиология', 31, 0),
  (41, '0000-00-00 00:00:00', '(020210) Биоинженерия и биоинформатика', 31, 0),
  (42, '0000-00-00 00:00:00', '(020300) Геология', 28, 1),
  (43, '0000-00-00 00:00:00', '(020301) Геология', 42, 0),
  (44, '0000-00-00 00:00:00', '(020302) Геофизика', 42, 0),
  (45, '0000-00-00 00:00:00', '(020303) Геохимия', 42, 0),
  (46, '0000-00-00 00:00:00', '(020304) Гидрогеология и инженерная геология', 42, 0),
  (47, '0000-00-00 00:00:00', '(020305) Геология и геохимия горючих ископаемых', 42, 0),
  (48, '0000-00-00 00:00:00', '(020306) Экологическая геология', 42, 0),
  (49, '0000-00-00 00:00:00', '(020400) География', 28, 1),
  (50, '0000-00-00 00:00:00', '(020401) География', 49, 0),
  (51, '0000-00-00 00:00:00', '(020500) География и картография', 28, 1),
  (52, '0000-00-00 00:00:00', '(020501) Картография', 51, 0),
  (53, '0000-00-00 00:00:00', '(020600) Гидрометеорология', 28, 1),
  (54, '0000-00-00 00:00:00', '(020601) Гидрология', 53, 0),
  (55, '0000-00-00 00:00:00', '(020602) Метеорология', 53, 0),
  (56, '0000-00-00 00:00:00', '(020603) Океанология', 53, 0),
  (57, '0000-00-00 00:00:00', '(020700) Почвоведение', 28, 1),
  (58, '0000-00-00 00:00:00', '(020701) Почвоведение', 57, 0),
  (59, '0000-00-00 00:00:00', '(020800) Экология и природопользование', 28, 1),
  (60, '0000-00-00 00:00:00', '(020801) Экология', 59, 0),
  (61, '0000-00-00 00:00:00', '(020802) Природопользование', 59, 0),
  (62, '0000-00-00 00:00:00', '(020803) Биоэкология', 59, 0),
  (63, '0000-00-00 00:00:00', '(020804) Геоэкология', 59, 0),
  (64, '0000-00-00 00:00:00', '(020900) Химия, физика и механика материалов', 28, 0),
  (65, '0000-00-00 00:00:00', '(030000) ГУМАНИТАРНЫЕ НАУКИ', 1000, 1),
  (66, '0000-00-00 00:00:00', '(030100) Философия', 65, 1),
  (67, '0000-00-00 00:00:00', '(030101) Философия', 66, 0),
  (68, '0000-00-00 00:00:00', '(030200) Политология', 65, 1),
  (69, '0000-00-00 00:00:00', '(030201) Политология', 68, 0),
  (70, '0000-00-00 00:00:00', '(030300) Психология', 65, 1),
  (71, '0000-00-00 00:00:00', '(030301) Психология', 70, 0),
  (72, '0000-00-00 00:00:00', '(030302) Клиническая психология', 70, 0),
  (73, '0000-00-00 00:00:00', '(030400) История', 65, 1),
  (74, '0000-00-00 00:00:00', '(030401) История', 73, 0),
  (75, '0000-00-00 00:00:00', '(030402) Историко-архивоведение', 73, 0),
  (76, '0000-00-00 00:00:00', '(030500) Юриспруденция', 65, 1),
  (77, '0000-00-00 00:00:00', '(030501) Юриспруденция', 76, 0),
  (78, '0000-00-00 00:00:00', '(030502) Судебная экспертиза', 76, 0),
  (79, '0000-00-00 00:00:00', '(030503) Правоведение', 76, 0),
  (80, '0000-00-00 00:00:00', '(030504) Право и организация социального обеспечения', 76, 0),
  (81, '0000-00-00 00:00:00', '(030505) Правоохранительная деятельность', 76, 0),
  (82, '0000-00-00 00:00:00', '(030600) Журналистика', 65, 1),
  (83, '0000-00-00 00:00:00', '(030601) Журналистика', 82, 0),
  (84, '0000-00-00 00:00:00', '(030602) Связи с общественностью', 82, 0),
  (85, '0000-00-00 00:00:00', '(030700) Международные отношения', 65, 1),
  (86, '0000-00-00 00:00:00', '(030701) Международные отношения', 85, 0),
  (87, '0000-00-00 00:00:00', '(030800) Востоковедение, африканистика', 65, 1),
  (88, '0000-00-00 00:00:00', '(030801) Востоковедение, африканистика', 87, 0),
  (89, '0000-00-00 00:00:00', '(030900) Книжное дело', 65, 1),
  (90, '0000-00-00 00:00:00', '(030901) Издательское дело и редактирование', 89, 0),
  (91, '0000-00-00 00:00:00', '(030902) Издательское дело', 89, 0),
  (92, '0000-00-00 00:00:00', '(030903) Книгораспространение', 89, 0),
  (93, '0000-00-00 00:00:00', '(031000) Филология', 65, 1),
  (94, '0000-00-00 00:00:00', '(031001) Филология', 93, 0),
  (95, '0000-00-00 00:00:00', '(031100) Лингвистика', 65, 0),
  (96, '0000-00-00 00:00:00', '(031200) Лингвистика и межкультурная коммуникация', 65, 1),
  (97, '0000-00-00 00:00:00', '(031201) Теория и методика преподавания иностранных языков и культур', 96, 0),
  (98, '0000-00-00 00:00:00', '(031202) Перевод и переводоведение', 96, 0),
  (99, '0000-00-00 00:00:00', '(031203) Теория и практика межкультурной коммуникации', 96, 0),
  (100, '0000-00-00 00:00:00', '(031300) Лингвистика и новые информационные технологии', 65, 1),
  (101, '0000-00-00 00:00:00', '(031301) Теоретическая и прикладная лингвистика', 100, 0),
  (102, '0000-00-00 00:00:00', '(031302) Интеллектуальные системы в гуманитарной сфере', 100, 0),
  (103, '0000-00-00 00:00:00', '(031400) Культурология', 65, 1),
  (104, '0000-00-00 00:00:00', '(031401) Культурология', 103, 0),
  (105, '0000-00-00 00:00:00', '(031500) Искусствоведение (по видам)', 65, 1),
  (106, '0000-00-00 00:00:00', '(031501) Искусствоведение', 105, 0),
  (107, '0000-00-00 00:00:00', '(031502) Музеология', 105, 0),
  (108, '0000-00-00 00:00:00', '(031600) Искусства и гуманитарные науки', 65, 0),
  (109, '0000-00-00 00:00:00', '(031700) Изящные искусства', 65, 0),
  (110, '0000-00-00 00:00:00', '(031800) Религиоведение', 65, 1),
  (111, '0000-00-00 00:00:00', '(031801) Религиоведение', 110, 0),
  (112, '0000-00-00 00:00:00', '(031900) Теология', 65, 1),
  (113, '0000-00-00 00:00:00', '(031901) Теология', 112, 0),
  (114, '0000-00-00 00:00:00', '(032000) Документоведение', 65, 1),
  (115, '0000-00-00 00:00:00', '(032001) Документоведение и документационное обеспечение управления', 114, 0),
  (116, '0000-00-00 00:00:00', '(032002) Документационное обеспечение управления и архивоведение', 114, 0),
  (117, '0000-00-00 00:00:00', '(032100) Физическая культура', 65, 1),
  (118, '0000-00-00 00:00:00', '(032101) Физическая культура и спорт', 117, 0),
  (119, '0000-00-00 00:00:00', '(032102) Физическая культура для лиц с отклонениями в состоянии здоровья (адаптивная физическая культура)', 117, 0),
  (120, '0000-00-00 00:00:00', '(032103) Рекреация и спортивно-оздоровительный туризм', 117, 0),
  (121, '0000-00-00 00:00:00', '(032200) Прикладная этика', 65, 0),
  (122, '0000-00-00 00:00:00', '(032300) Регионоведение', 65, 1),
  (123, '0000-00-00 00:00:00', '(032301) Регионоведение', 122, 0),
  (124, '0000-00-00 00:00:00', '(032400) Реклама', 65, 1),
  (125, '0000-00-00 00:00:00', '(032401) Реклама', 124, 0),
  (126, '0000-00-00 00:00:00', '(040000) СОЦИАЛЬНЫЕ НАУКИ', 1000, 1),
  (127, '0000-00-00 00:00:00', '(040100) Социальная работа', 126, 1),
  (128, '0000-00-00 00:00:00', '(040101) Социальная работа', 127, 0),
  (129, '0000-00-00 00:00:00', '(040102) Социальная антропология', 127, 0),
  (130, '0000-00-00 00:00:00', '(040103) Организация сурдокоммуникации', 127, 0),
  (131, '0000-00-00 00:00:00', '(040104) Организация работы с молодежью', 127, 0),
  (132, '0000-00-00 00:00:00', '(040200) Социология', 126, 1),
  (133, '0000-00-00 00:00:00', '(040201) Социология', 132, 0),
  (134, '0000-00-00 00:00:00', '(040300) Конфликтология', 126, 0),
  (135, '0000-00-00 00:00:00', '(050000) ОБРАЗОВАНИЕ И ПЕДАГОГИКА', 1000, 1),
  (136, '0000-00-00 00:00:00', '(050100) Естественнонаучное образование', 135, 1),
  (137, '0000-00-00 00:00:00', '(050101) Химия', 136, 0),
  (138, '0000-00-00 00:00:00', '(050102) Биология', 136, 0),
  (139, '0000-00-00 00:00:00', '(050103) География', 136, 0),
  (140, '0000-00-00 00:00:00', '(050104) Безопасность жизнедеятельности', 136, 0),
  (141, '0000-00-00 00:00:00', '(050200) Физико-математическое образование', 135, 1),
  (142, '0000-00-00 00:00:00', '(050201) Математика', 141, 0),
  (143, '0000-00-00 00:00:00', '(050202) Информатика', 141, 0),
  (144, '0000-00-00 00:00:00', '(050203) Физика', 141, 0),
  (145, '0000-00-00 00:00:00', '(050300) Филологическое образование', 135, 1),
  (146, '0000-00-00 00:00:00', '(050301) Русский язык и литература', 145, 0),
  (147, '0000-00-00 00:00:00', '(050302) Родной язык и литература', 145, 0),
  (148, '0000-00-00 00:00:00', '(050303) Иностранный язык', 145, 0),
  (149, '0000-00-00 00:00:00', '(050400) Социально-экономическое образование', 135, 1),
  (150, '0000-00-00 00:00:00', '(050401) История', 149, 0),
  (151, '0000-00-00 00:00:00', '(050402) Юриспруденция', 149, 0),
  (152, '0000-00-00 00:00:00', '(050403) Культурология', 149, 0),
  (153, '0000-00-00 00:00:00', '(050500) Технологическое образование', 135, 1),
  (154, '0000-00-00 00:00:00', '(050501) Профессиональное обучение (по отраслям)', 153, 0),
  (155, '0000-00-00 00:00:00', '(050502) Технология и предпринимательство', 153, 0),
  (156, '0000-00-00 00:00:00', '(050503) Технология', 153, 0),
  (157, '0000-00-00 00:00:00', '(050600) Художественное образование', 135, 1),
  (158, '0000-00-00 00:00:00', '(050601) Музыкальное образование', 157, 0),
  (159, '0000-00-00 00:00:00', '(050602) Изобразительное искусство', 157, 0),
  (160, '0000-00-00 00:00:00', '(050603) Изобразительное искусство и черчение', 157, 0),
  (161, '0000-00-00 00:00:00', '(050700) Педагогика', 135, 1),
  (162, '0000-00-00 00:00:00', '(050701) Педагогика', 161, 0),
  (163, '0000-00-00 00:00:00', '(050702) Организация воспитательной деятельности', 161, 0),
  (164, '0000-00-00 00:00:00', '(050703) Дошкольная педагогика и психология', 161, 0),
  (165, '0000-00-00 00:00:00', '(050704) Дошкольное образование', 161, 0),
  (166, '0000-00-00 00:00:00', '(050705) Специальное дошкольное образование', 161, 0),
  (167, '0000-00-00 00:00:00', '(050706) Педагогика и психология', 161, 0),
  (168, '0000-00-00 00:00:00', '(050707) Педагогика и методика дошкольного образования', 161, 0),
  (169, '0000-00-00 00:00:00', '(050708) Педагогика и методика начального образования', 161, 0),
  (170, '0000-00-00 00:00:00', '(050709) Преподавание в начальных классах', 161, 0),
  (171, '0000-00-00 00:00:00', '(050710) Педагогика дополнительного образования', 161, 0),
  (172, '0000-00-00 00:00:00', '(050711) Социальная педагогика', 161, 0),
  (173, '0000-00-00 00:00:00', '(050712) Тифлопедагогика', 161, 0),
  (174, '0000-00-00 00:00:00', '(050713) Сурдопедагогика', 161, 0),
  (175, '0000-00-00 00:00:00', '(050714) Олигофренопедагогика', 161, 0),
  (176, '0000-00-00 00:00:00', '(050715) Логопедия', 161, 0),
  (177, '0000-00-00 00:00:00', '(050716) Специальная психология', 161, 0),
  (178, '0000-00-00 00:00:00', '(050717) Специальная дошкольная педагогика и психология', 161, 0),
  (179, '0000-00-00 00:00:00', '(050718) Специальная педагогика в специальных (коррекционных) образовательных учреждениях', 161, 0),
  (180, '0000-00-00 00:00:00', '(050719) Коррекционная педагогика в начальном образовании', 161, 0),
  (181, '0000-00-00 00:00:00', '(050720) Физическая культура', 161, 0),
  (182, '0000-00-00 00:00:00', '(050721) Адаптивная физическая культура', 161, 0),
  (183, '0000-00-00 00:00:00', '(060000) ЗДРАВООХРАНЕНИЕ', 1000, 1),
  (184, '0000-00-00 00:00:00', '(060100) Здравоохранение', 183, 1),
  (185, '0000-00-00 00:00:00', '(060101) Лечебное дело', 184, 0),
  (186, '0000-00-00 00:00:00', '(060102) Акушерское дело', 184, 0),
  (187, '0000-00-00 00:00:00', '(060103) Педиатрия', 184, 0),
  (188, '0000-00-00 00:00:00', '(060104) Медико-профилактическое дело', 184, 0),
  (189, '0000-00-00 00:00:00', '(060105) Стоматология', 184, 0),
  (190, '0000-00-00 00:00:00', '(060106) Стоматология ортопедическая', 184, 0),
  (191, '0000-00-00 00:00:00', '(060107) Стоматология профилактическая', 184, 0),
  (192, '0000-00-00 00:00:00', '(060108) Фармацея', 184, 0),
  (193, '0000-00-00 00:00:00', '(060109) Сестринское дело', 184, 0),
  (194, '0000-00-00 00:00:00', '(060110) Лабораторная диагностика', 184, 0),
  (195, '0000-00-00 00:00:00', '(060111) Медицинская оптика', 184, 0),
  (196, '0000-00-00 00:00:00', '(060112) Медицинская биохимия', 184, 0),
  (197, '0000-00-00 00:00:00', '(060113) Медицинская биофизика', 184, 0),
  (198, '0000-00-00 00:00:00', '(060114) Медицинская кибернетика', 184, 0),
  (199, '0000-00-00 00:00:00', '(070000) КУЛЬТУРА И ИСКУССТВО', 1000, 1),
  (200, '0000-00-00 00:00:00', '(070100) Музыкальное искусство', 199, 1),
  (201, '0000-00-00 00:00:00', '(070101) Инструментальное исполнительство (по видам инструментов: фортепиано, орган; оркестровые струнные инструменты; оркестровые духовые и ударные инструменты; оркестровые народные инструменты)', 200, 0),
  (202, '0000-00-00 00:00:00', '(070102) Инструментальное исполнительство (по видам инструментов)', 200, 0),
  (203, '0000-00-00 00:00:00', '(070103) Вокальное искусство (по видам вокального искусства: академическое пение; народное пение)', 200, 0),
  (204, '0000-00-00 00:00:00', '(070104) Вокальное искусство', 200, 0),
  (205, '0000-00-00 00:00:00', '(070105) Дирижирование (по видам исполнительских коллективов: дирижирование оперно-симфоническим оркестром; дирижирование академическим хором; дирижирование народным хором; дирижирование военно-духовым оркестром)', 200, 0),
  (206, '0000-00-00 00:00:00', '(070106) Хоровое дирижирование', 200, 0),
  (207, '0000-00-00 00:00:00', '(070107) Композиция', 200, 0),
  (208, '0000-00-00 00:00:00', '(070108) Музыкальное искусство эстрады (по видам эстрадного искусства: инструменты эстрадного оркестра; эстрадно-джазовое пение)', 200, 0),
  (209, '0000-00-00 00:00:00', '(070109) Музыкальное искусство эстрады (по видам)', 200, 0),
  (210, '0000-00-00 00:00:00', '(070110) Музыкальная звукорежиссура', 200, 0),
  (211, '0000-00-00 00:00:00', '(070111) Музыковедение', 200, 0),
  (212, '0000-00-00 00:00:00', '(070112) Этномузыкология', 200, 0),
  (213, '0000-00-00 00:00:00', '(070113) Теория музыки', 200, 0),
  (214, '0000-00-00 00:00:00', '(070200) Театральное искусство', 199, 1),
  (215, '0000-00-00 00:00:00', '(070201) Актерское искусство', 214, 0),
  (216, '0000-00-00 00:00:00', '(070202) Цирковое искусство', 214, 0),
  (217, '0000-00-00 00:00:00', '(070203) Искусство эстрады', 214, 0),
  (218, '0000-00-00 00:00:00', '(070204) Режиссура театра', 214, 0),
  (219, '0000-00-00 00:00:00', '(070205) Технология художественного оформления спектакля', 214, 0),
  (220, '0000-00-00 00:00:00', '(070206) Театрально-декорационное искусство', 214, 0),
  (221, '0000-00-00 00:00:00', '(070207) Сценография', 214, 0),
  (222, '0000-00-00 00:00:00', '(070208) Звукорежиссура театрализованных представлений и праздников', 214, 0),
  (223, '0000-00-00 00:00:00', '(070209) Режиссура театрализованных представлений и праздников', 214, 0),
  (224, '0000-00-00 00:00:00', '(070210) Драматургия', 214, 0),
  (225, '0000-00-00 00:00:00', '(070211) Театроведение', 214, 0),
  (226, '0000-00-00 00:00:00', '(070300) Искусство балета', 199, 1),
  (227, '0000-00-00 00:00:00', '(070301) Хореографическое исполнительство', 226, 0),
  (228, '0000-00-00 00:00:00', '(070302) Хореографическое искусство', 226, 0),
  (229, '0000-00-00 00:00:00', '(070303) Искусство хореографа', 226, 0),
  (230, '0000-00-00 00:00:00', '(070304) Педагогика балета', 226, 0),
  (231, '0000-00-00 00:00:00', '(070305) История и теория хореографического искусства', 226, 0),
  (232, '0000-00-00 00:00:00', '(070400) Светорежиссура', 199, 1),
  (233, '0000-00-00 00:00:00', '(070401) Светорежиссура', 232, 0),
  (234, '0000-00-00 00:00:00', '(070500) Реставрация', 199, 1),
  (235, '0000-00-00 00:00:00', '(070501) Реставрация', 234, 0),
  (236, '0000-00-00 00:00:00', '(070502) Реставрация, консервация и хранение произведений искусства', 234, 0),
  (237, '0000-00-00 00:00:00', '(070503) Музейное дело и охрана памятников', 234, 0),
  (238, '0000-00-00 00:00:00', '(070600) Дизайн', 199, 1),
  (239, '0000-00-00 00:00:00', '(070601) Дизайн', 238, 0),
  (240, '0000-00-00 00:00:00', '(070602) Дизайн (по отраслям)', 238, 0),
  (241, '0000-00-00 00:00:00', '(070603) Искусство интерьера', 238, 0),
  (242, '0000-00-00 00:00:00', '(070800) Декоративно-прикладное искусство и народные промыслы', 199, 1),
  (243, '0000-00-00 00:00:00', '(070801) Декоративно-прикладное искусство', 242, 0),
  (244, '0000-00-00 00:00:00', '(070802) Декоративно-прикладное искусство и народные промыслы', 242, 0),
  (245, '0000-00-00 00:00:00', '(070900) Изобразительное искусство', 199, 1),
  (246, '0000-00-00 00:00:00', '(070901) Живопись', 245, 0),
  (247, '0000-00-00 00:00:00', '(070902) Графика', 245, 0),
  (248, '0000-00-00 00:00:00', '(070903) Скульптура', 245, 0),
  (249, '0000-00-00 00:00:00', '(070904) Монументально-декоративное искусство', 245, 0),
  (250, '0000-00-00 00:00:00', '(070905) Зодчество', 245, 0),
  (251, '0000-00-00 00:00:00', '(070906) История и теория изобразительного искусства', 245, 0),
  (252, '0000-00-00 00:00:00', '(071000) Литературное творчество', 199, 1),
  (253, '0000-00-00 00:00:00', '(071001) Литературное творчество', 252, 0),
  (254, '0000-00-00 00:00:00', '(071100) Киноискусство', 199, 1),
  (255, '0000-00-00 00:00:00', '(071101) Режиссура кино и телевидения', 254, 0),
  (256, '0000-00-00 00:00:00', '(071102) Режиссура мультимедиапрограмм', 254, 0),
  (257, '0000-00-00 00:00:00', '(071103) Продюсерство кино и телевидения', 254, 0),
  (258, '0000-00-00 00:00:00', '(071104) Звукорежиссура кино и телевидения', 254, 0),
  (259, '0000-00-00 00:00:00', '(071105) Кинооператорство', 254, 0),
  (260, '0000-00-00 00:00:00', '(071106) Киноведение', 254, 0),
  (261, '0000-00-00 00:00:00', '(071200) Библиотечно-информационные ресурсы', 199, 1),
  (262, '0000-00-00 00:00:00', '(071201) Библиотечно-информационная деятельность', 261, 0),
  (263, '0000-00-00 00:00:00', '(071202) Библиотековедение', 261, 0),
  (264, '0000-00-00 00:00:00', '(071300) Народная художественная культура', 199, 1),
  (265, '0000-00-00 00:00:00', '(071301) Народное художественное творчество', 264, 0),
  (266, '0000-00-00 00:00:00', '(071302) Социально-культурная деятельность и народное художественное творчество', 264, 0),
  (267, '0000-00-00 00:00:00', '(071400) Социально-культурная деятельность', 199, 1),
  (268, '0000-00-00 00:00:00', '(071401) Социально-культурная деятельность', 267, 0),
  (269, '0000-00-00 00:00:00', '(071500) Художественное проектирование изделий текстильной и легкой промышленности', 199, 1),
  (270, '0000-00-00 00:00:00', '(071501) Художественное проектирование костюма', 269, 0),
  (271, '0000-00-00 00:00:00', '(071502) Художественное проектирование текстильных изделий', 269, 0),
  (272, '0000-00-00 00:00:00', '(071503) Художественное проектирование изделий из кожи', 269, 0),
  (273, '0000-00-00 00:00:00', '(071504) Художественное проектирование ювелирных изделий', 269, 0),
  (274, '0000-00-00 00:00:00', '(071505) Художественное оформление изделий текстильной и легкой промышленности', 269, 0),
  (275, '0000-00-00 00:00:00', '(080000) ЭКОНОМИКА И УПРАВЛЕНИЕ', 1000, 1),
  (276, '0000-00-00 00:00:00', '(080100) Экономика', 275, 1),
  (277, '0000-00-00 00:00:00', '(080101) Экономическая теория', 276, 0),
  (278, '0000-00-00 00:00:00', '(080102) Мировая экономика', 276, 0),
  (279, '0000-00-00 00:00:00', '(080103) Национальная экономика', 276, 0),
  (280, '0000-00-00 00:00:00', '(080104) Экономика труда', 276, 0),
  (281, '0000-00-00 00:00:00', '(080105) Финансы и кредит', 276, 0),
  (282, '0000-00-00 00:00:00', '(080106) Финансы (по отраслям)', 276, 0),
  (283, '0000-00-00 00:00:00', '(080107) Налоги и налогообложение', 276, 0),
  (284, '0000-00-00 00:00:00', '(080108) Банковское дело', 276, 0),
  (285, '0000-00-00 00:00:00', '(080109) Бухгалтерский учет, анализ и аудит', 276, 0),
  (286, '0000-00-00 00:00:00', '(080110) Экономика и бухгалтерский учет (по отраслям)', 276, 0),
  (287, '0000-00-00 00:00:00', '(080111) Маркетинг', 276, 0),
  (288, '0000-00-00 00:00:00', '(080112) Маркетинг (по отраслям)', 276, 0),
  (289, '0000-00-00 00:00:00', '(080113) Страховое дело (по отраслям)', 276, 0),
  (290, '0000-00-00 00:00:00', '(080114) Земельно-имущественные отношения', 276, 0),
  (291, '0000-00-00 00:00:00', '(080115) Таможенное дело', 276, 0),
  (292, '0000-00-00 00:00:00', '(080116) Математические методы в экономике', 276, 0),
  (293, '0000-00-00 00:00:00', '(080300) Коммерция', 275, 1),
  (294, '0000-00-00 00:00:00', '(080301) Коммерция (торговое дело)', 293, 0),
  (295, '0000-00-00 00:00:00', '(080302) Коммерция (по отраслям)', 293, 0),
  (296, '0000-00-00 00:00:00', '(080400) Товароведение', 275, 1),
  (297, '0000-00-00 00:00:00', '(080401) Товароведение и экспертиза товаров (по областям применения)', 296, 0),
  (298, '0000-00-00 00:00:00', '(080402) Товароведение (по группам однородных товаров)', 296, 0),
  (299, '0000-00-00 00:00:00', '(080500) Менеджмент', 275, 1),
  (300, '0000-00-00 00:00:00', '(080501) Менеджмент (по отраслям)', 299, 0),
  (301, '0000-00-00 00:00:00', '(080502) Экономика и управление на предприятии (по отраслям)', 299, 0),
  (302, '0000-00-00 00:00:00', '(080503) Антикризисное управление', 299, 0),
  (303, '0000-00-00 00:00:00', '(080504) Государственное и муниципальное управление', 299, 0),
  (304, '0000-00-00 00:00:00', '(080505) Управление персоналом', 299, 0),
  (305, '0000-00-00 00:00:00', '(080506) Логистика', 299, 0),
  (306, '0000-00-00 00:00:00', '(080507) Менеджмент организации', 299, 0),
  (307, '0000-00-00 00:00:00', '(080600) Статистика', 275, 1),
  (308, '0000-00-00 00:00:00', '(080601) Статистика', 307, 0),
  (309, '0000-00-00 00:00:00', '(080700) Бизнес-информатика', 275, 0),
  (310, '0000-00-00 00:00:00', '(080800) Прикладная информатика', 275, 1),
  (311, '0000-00-00 00:00:00', '(080801) Прикладная информатика (по областям)', 310, 0),
  (312, '0000-00-00 00:00:00', '(080802) Прикладная информатика (по отраслям)', 310, 0),
  (313, '0000-00-00 00:00:00', '(090000) ИНФОРМАЦИОННАЯ БЕЗОПАСНОСТЬ', 1000, 1),
  (314, '0000-00-00 00:00:00', '(090100) Информационная безопасность', 313, 1),
  (315, '0000-00-00 00:00:00', '(090101) Криптография', 314, 0),
  (316, '0000-00-00 00:00:00', '(090102) Компьютерная безопасность', 314, 0),
  (317, '0000-00-00 00:00:00', '(090103) Организация и технология защиты информации', 314, 0),
  (318, '0000-00-00 00:00:00', '(090104) Комплексная защита объектов информатизации', 314, 0),
  (319, '0000-00-00 00:00:00', '(090105) Комплексное обеспечение информационной безопасности автоматизированных систем', 314, 0),
  (320, '0000-00-00 00:00:00', '(090106) Информационная безопасность телекоммуникационных систем', 314, 0),
  (321, '0000-00-00 00:00:00', '(090107) Противодействие техническим разведкам', 314, 0),
  (322, '0000-00-00 00:00:00', '(090108) Информационная безопасность', 314, 0),
  (323, '0000-00-00 00:00:00', '(100000) СФЕРА ОБСЛУЖИВАНИЯ', 1000, 1),
  (324, '0000-00-00 00:00:00', '(100100) Сервис', 323, 1),
  (325, '0000-00-00 00:00:00', '(100101) Сервис', 324, 0),
  (326, '0000-00-00 00:00:00', '(100102) Организация обслуживания в сфере сервиса', 324, 0),
  (327, '0000-00-00 00:00:00', '(100103) Социально-культурный сервис и туризм', 324, 0),
  (328, '0000-00-00 00:00:00', '(100105) Гостиничный сервис', 324, 0),
  (329, '0000-00-00 00:00:00', '(100106) Организация обслуживания в общественном питании', 324, 0),
  (330, '0000-00-00 00:00:00', '(100107) Сервис по химической обработке изделий', 324, 0),
  (331, '0000-00-00 00:00:00', '(100108) Парикмахерское искусство', 324, 0),
  (332, '0000-00-00 00:00:00', '(100109) Косметика и визажное искусство', 324, 0),
  (333, '0000-00-00 00:00:00', '(100110) Домоведение', 324, 0),
  (334, '0000-00-00 00:00:00', '(100111) Техника и искусство фотографии', 324, 0),
  (335, '0000-00-00 00:00:00', '(100112) Сервис на транспорте (по видам транспорта)', 324, 0),
  (336, '0000-00-00 00:00:00', '(100200) Туризм', 323, 1),
  (337, '0000-00-00 00:00:00', '(100201) Туризм', 336, 0),
  (338, '0000-00-00 00:00:00', '(110000) СЕЛЬСКОЕ И РЫБНОЕ ХОЗЯЙСТВО', 1000, 1),
  (339, '0000-00-00 00:00:00', '(110100) Агрохимия и агропочвоведение', 338, 1),
  (340, '0000-00-00 00:00:00', '(110101) Агрохимия и агропочвоведение', 339, 0),
  (341, '0000-00-00 00:00:00', '(110102) Агроэкология', 339, 0),
  (342, '0000-00-00 00:00:00', '(110200) Агрономия', 338, 1),
  (343, '0000-00-00 00:00:00', '(110201) Агрономия', 342, 0),
  (344, '0000-00-00 00:00:00', '(110202) Плодоовощеводство и виноградарство', 342, 0),
  (345, '0000-00-00 00:00:00', '(110203) Защита растений', 342, 0),
  (346, '0000-00-00 00:00:00', '(110204) Селекция и генетика сельскохозяйственных культур', 342, 0),
  (347, '0000-00-00 00:00:00', '(110300) Агроинженерия', 338, 1),
  (348, '0000-00-00 00:00:00', '(110301) Механизация сельского хозяйства', 347, 0),
  (349, '0000-00-00 00:00:00', '(110302) Электрификация и автоматизация сельского хозяйства', 347, 0),
  (350, '0000-00-00 00:00:00', '(110303) Механизация переработки сельскохозяйственной продукции', 347, 0),
  (351, '0000-00-00 00:00:00', '(110304) Технология обслуживания и ремонта машин в агропромышленном комплексе', 347, 0),
  (352, '0000-00-00 00:00:00', '(110305) Технология производства и переработки сельскохозяйственной продукции', 347, 0),
  (353, '0000-00-00 00:00:00', '(110306) Хранение и переработка растениеводческой продукции', 347, 0),
  (354, '0000-00-00 00:00:00', '(110400) Зоотехния', 338, 1),
  (355, '0000-00-00 00:00:00', '(110401) Зоотехния', 354, 0),
  (356, '0000-00-00 00:00:00', '(110500) Ветеринарно-санитарная экспертиза', 338, 1),
  (357, '0000-00-00 00:00:00', '(110501) Ветеринарно-санитарная экспертиза', 356, 0),
  (358, '0000-00-00 00:00:00', '(110600) Пчеловодство', 338, 1),
  (359, '0000-00-00 00:00:00', '(110601) Пчеловодство', 358, 0),
  (360, '0000-00-00 00:00:00', '(110700) Охотоведение и звероводство', 338, 1),
  (361, '0000-00-00 00:00:00', '(110701) Охотоведение и звероводство', 360, 0),
  (362, '0000-00-00 00:00:00', '(110800) Кинология', 338, 1),
  (363, '0000-00-00 00:00:00', '(110801) Кинология', 362, 0),
  (364, '0000-00-00 00:00:00', '(110900) Водные биоресурсы и аквакультура', 338, 1),
  (365, '0000-00-00 00:00:00', '(110901) Водные биоресурсы и аквакультура', 364, 0),
  (366, '0000-00-00 00:00:00', '(110902) Ихтиология и рыбоводство', 364, 0),
  (367, '0000-00-00 00:00:00', '(111000) Рыболовство', 338, 1),
  (368, '0000-00-00 00:00:00', '(111001) Промышленное рыболовство', 367, 0),
  (369, '0000-00-00 00:00:00', '(111100) Организация фермерского хозяйства', 338, 1),
  (370, '0000-00-00 00:00:00', '(111101) Организация фермерского хозяйства', 369, 0),
  (371, '0000-00-00 00:00:00', '(111200) Ветеринария', 338, 1),
  (372, '0000-00-00 00:00:00', '(111201) Ветеринария', 371, 0),
  (373, '0000-00-00 00:00:00', '(120000) ГЕОДЕЗИЯ И ЗЕМЛЕУСТРОЙСТВО', 1000, 1),
  (374, '0000-00-00 00:00:00', '(120100) Геодезия', 373, 1),
  (375, '0000-00-00 00:00:00', '(120101) Прикладная геодезия', 374, 0),
  (376, '0000-00-00 00:00:00', '(120102) Астрономогеодезия', 374, 0),
  (377, '0000-00-00 00:00:00', '(120103) Космическая геодезия', 374, 0),
  (378, '0000-00-00 00:00:00', '(120200) Фотограмметрия и дистанционное зондирование', 373, 1),
  (379, '0000-00-00 00:00:00', '(120201) Исследование природных ресурсов аэрокосмическими средствами', 378, 0),
  (380, '0000-00-00 00:00:00', '(120202) Аэрофотогеодезия', 378, 0),
  (381, '0000-00-00 00:00:00', '(120300) Землеустройство и кадастры', 373, 1),
  (382, '0000-00-00 00:00:00', '(120301) Землеустройство', 381, 0),
  (383, '0000-00-00 00:00:00', '(120302) Земельный кадастр', 381, 0),
  (384, '0000-00-00 00:00:00', '(120303) Городской кадастр', 381, 0),
  (385, '0000-00-00 00:00:00', '(120304) Градостроительный кадастр', 381, 0),
  (386, '0000-00-00 00:00:00', '(130000) ГЕОЛОГИЯ, РАЗВЕДКА И РАЗРАБОТКА ПОЛЕЗНЫХ ИСКОПАЕМЫХ', 1000, 1),
  (387, '0000-00-00 00:00:00', '(130100) Геология и разведка полезных ископаемых', 386, 0),
  (388, '0000-00-00 00:00:00', '(130200) Технологии геологической разведки', 386, 1),
  (389, '0000-00-00 00:00:00', '(130201) Геофизические методы поисков и разведки месторождений полезных ископаемых', 388, 0),
  (390, '0000-00-00 00:00:00', '(130202) Геофизические методы исследования скважин', 388, 0),
  (391, '0000-00-00 00:00:00', '(130203) Технология и техника разведки месторождений полезных ископаемых', 388, 0),
  (392, '0000-00-00 00:00:00', '(130300) Прикладная геология', 386, 1),
  (393, '0000-00-00 00:00:00', '(130301) Геологическая съемка, поиски и разведка месторождений полезных ископаемых', 392, 0),
  (394, '0000-00-00 00:00:00', '(130302) Поиски и разведка подземных вод и инженерно-геологические изыскания', 392, 0),
  (395, '0000-00-00 00:00:00', '(130303) Гидрогеология и инженерная геология', 392, 0),
  (396, '0000-00-00 00:00:00', '(130304) Геология нефти и газа', 392, 0),
  (397, '0000-00-00 00:00:00', '(130305) Геология и разведка нефтяных и газовых месторождений', 392, 0),
  (398, '0000-00-00 00:00:00', '(130306) Прикладная геохимия, петрология, минералогия', 392, 0),
  (399, '0000-00-00 00:00:00', '(130400) Горное дело', 386, 1),
  (400, '0000-00-00 00:00:00', '(130401) Физические процессы горного или нефтегазового производства', 399, 0),
  (401, '0000-00-00 00:00:00', '(130402) Маркшейдерское дело', 399, 0),
  (402, '0000-00-00 00:00:00', '(130403) Открытые горные работы', 399, 0),
  (403, '0000-00-00 00:00:00', '(130404) Подземная разработка месторождений полезных ископаемых', 399, 0),
  (404, '0000-00-00 00:00:00', '(130405) Обогащение полезных ископаемых', 399, 0),
  (405, '0000-00-00 00:00:00', '(130406) Шахтное и подземное строительство', 399, 0),
  (406, '0000-00-00 00:00:00', '(130407) Шахтное строительство', 399, 0),
  (407, '0000-00-00 00:00:00', '(130408) Взрывное дело', 399, 0),
  (408, '0000-00-00 00:00:00', '(130500) Нефтегазовое дело', 386, 1),
  (409, '0000-00-00 00:00:00', '(130501) Проектирование, сооружение и эксплуатация газонефтепроводов и газонефтехранилищ', 408, 0),
  (410, '0000-00-00 00:00:00', '(130502) Сооружение и эксплуатация газонефтепроводов и газонефтехранилищ', 408, 0),
  (411, '0000-00-00 00:00:00', '(130503) Разработка и эксплуатация нефтяных и газовых месторождений', 408, 0),
  (412, '0000-00-00 00:00:00', '(130504) Бурение нефтяных и газовых скважин', 408, 0),
  (413, '0000-00-00 00:00:00', '(130600) Оборудование и агрегаты нефтегазового производства', 386, 1),
  (414, '0000-00-00 00:00:00', '(130601) Морские нефтегазовые сооружения', 413, 0),
  (415, '0000-00-00 00:00:00', '(130602) Машины и оборудование нефтяных и газовых промыслов', 413, 0),
  (416, '0000-00-00 00:00:00', '(130603) Оборудование нефтегазопереработки', 413, 0),
  (417, '0000-00-00 00:00:00', '(140000) ЭНЕРГЕТИКА, ЭНЕРГЕТИЧЕСКОЕ МАШИНОСТРОЕНИЕ И ЭЛЕКТРОТЕХНИКА', 1000, 1),
  (418, '0000-00-00 00:00:00', '(140100) Теплоэнергетика', 417, 1),
  (419, '0000-00-00 00:00:00', '(140101) Тепловые электрические станции', 418, 0),
  (420, '0000-00-00 00:00:00', '(140102) Теплоснабжение и теплотехническое оборудование', 418, 0),
  (421, '0000-00-00 00:00:00', '(140103) Технология воды и топлива на тепловых и атомных электрических станциях', 418, 0),
  (422, '0000-00-00 00:00:00', '(140104) Промышленная теплоэнергетика', 418, 0),
  (423, '0000-00-00 00:00:00', '(140105) Энергетика теплотехнологий', 418, 0),
  (424, '0000-00-00 00:00:00', '(140106) Энергообеспечение предприятий', 418, 0),
  (425, '0000-00-00 00:00:00', '(140200) Электроэнергетика', 417, 1),
  (426, '0000-00-00 00:00:00', '(140201) Высоковольтная электроэнергетика и электротехника', 425, 0),
  (427, '0000-00-00 00:00:00', '(140202) Нетрадиционные и возобновляемые источники энергии', 425, 0),
  (428, '0000-00-00 00:00:00', '(140203) Релейная защита и автоматизация электроэнергетических систем', 425, 0),
  (429, '0000-00-00 00:00:00', '(140204) Электрические станции', 425, 0),
  (430, '0000-00-00 00:00:00', '(140205) Электроэнергетические системы и сети', 425, 0),
  (431, '0000-00-00 00:00:00', '(140206) Электрические станции, сети и системы', 425, 0),
  (432, '0000-00-00 00:00:00', '(140207) Технология воды, топлива и смазочных материалов на электрических станциях', 425, 0),
  (433, '0000-00-00 00:00:00', '(140208) Монтаж и эксплуатация линий электропередачи', 425, 0),
  (434, '0000-00-00 00:00:00', '(140209) Гидроэлектростанции', 425, 0),
  (435, '0000-00-00 00:00:00', '(140210) Гидроэлектроэнергетические установки', 425, 0),
  (436, '0000-00-00 00:00:00', '(140211) Электроснабжение', 425, 0),
  (437, '0000-00-00 00:00:00', '(140212) Электроснабжение (по отраслям)', 425, 0),
  (438, '0000-00-00 00:00:00', '(140300) Ядерные физика и технологии', 417, 1),
  (439, '0000-00-00 00:00:00', '(140301) Физика конденсированного состояния вещества', 438, 0),
  (440, '0000-00-00 00:00:00', '(140302) Физика атомного ядра и частиц', 438, 0),
  (441, '0000-00-00 00:00:00', '(140303) Физика кинетических явлений', 438, 0),
  (442, '0000-00-00 00:00:00', '(140304) Физика пучков заряженных частиц и ускорительная техника', 438, 0),
  (443, '0000-00-00 00:00:00', '(140305) Ядерные реакторы и энергетические установки', 438, 0),
  (444, '0000-00-00 00:00:00', '(140306) Электроника и автоматика физических установок', 438, 0),
  (445, '0000-00-00 00:00:00', '(140307) Радиационная безопасность человека и окружающей среды', 438, 0),
  (446, '0000-00-00 00:00:00', '(140308) Радиационная безопасность', 438, 0),
  (447, '0000-00-00 00:00:00', '(140309) Безопасность и нераспространение ядерных материалов', 438, 0),
  (448, '0000-00-00 00:00:00', '(140400) Техническая физика', 417, 1),
  (449, '0000-00-00 00:00:00', '(140401) Техника и физика низких температур', 448, 0),
  (450, '0000-00-00 00:00:00', '(140402) Теплофизика', 448, 0),
  (451, '0000-00-00 00:00:00', '(140403) Техническая физика термоядерных реакторов и плазменных установок', 448, 0),
  (452, '0000-00-00 00:00:00', '(140404) Атомные электрические станции и установки', 448, 0),
  (453, '0000-00-00 00:00:00', '(140500) Энергомашиностроение', 417, 1),
  (454, '0000-00-00 00:00:00', '(140501) Двигатели внутреннего сгорания', 453, 0),
  (455, '0000-00-00 00:00:00', '(140502) Котлои реакторостроение', 453, 0),
  (456, '0000-00-00 00:00:00', '(140503) Газотурбинные, паротурбинные установки и двигатели', 453, 0),
  (457, '0000-00-00 00:00:00', '(140504) Холодильная, криогенная техника и кондиционирование', 453, 0),
  (458, '0000-00-00 00:00:00', '(140505) Плазменные энергетические установки', 453, 0),
  (459, '0000-00-00 00:00:00', '(140600) Электротехника, электромеханика и электротехнологии', 417, 1),
  (460, '0000-00-00 00:00:00', '(140601) Электромеханика', 459, 0),
  (461, '0000-00-00 00:00:00', '(140602) Электрические и электронные аппараты', 459, 0),
  (462, '0000-00-00 00:00:00', '(140603) Электрические машины и аппараты', 459, 0),
  (463, '0000-00-00 00:00:00', '(140604) Электропривод и автоматика промышленных установок и технологических комплексов', 459, 0),
  (464, '0000-00-00 00:00:00', '(140605) Электротехнологические установки и системы', 459, 0),
  (465, '0000-00-00 00:00:00', '(140606) Электрический транспорт', 459, 0),
  (466, '0000-00-00 00:00:00', '(140607) Электрооборудование автомобилей и тракторов', 459, 0),
  (467, '0000-00-00 00:00:00', '(140608) Электрооборудование и автоматика судов', 459, 0),
  (468, '0000-00-00 00:00:00', '(140609) Электрооборудование летательных аппаратов', 459, 0),
  (469, '0000-00-00 00:00:00', '(140610) Электрооборудование и электрохозяйство предприятий, организаций и учреждений', 459, 0),
  (470, '0000-00-00 00:00:00', '(140611) Электроизоляционная, кабельная и конденсаторная техника', 459, 0),
  (471, '0000-00-00 00:00:00', '(140612) Электротехнические устройства', 459, 0),
  (472, '0000-00-00 00:00:00', '(140613) Техническая эксплуатация и обслуживание электрического и электромеханического оборудования (по отраслям)', 459, 0),
  (473, '0000-00-00 00:00:00', '(150000) МЕТАЛЛУРГИЯ, МАШИНОСТРОЕНИЕ И МАТЕРИАЛООБРАБОТКА', 1000, 1),
  (474, '0000-00-00 00:00:00', '(150100) Металлургия', 473, 1),
  (475, '0000-00-00 00:00:00', '(150101) Металлургия черных металлов', 474, 0),
  (476, '0000-00-00 00:00:00', '(150102) Металлургия цветных металлов', 474, 0),
  (477, '0000-00-00 00:00:00', '(150103) Теплофизика, автоматизация и экология промышленных печей', 474, 0),
  (478, '0000-00-00 00:00:00', '(150104) Литейное производство черных и цветных металлов', 474, 0),
  (479, '0000-00-00 00:00:00', '(150105) Металловедение и термическая обработка металлов', 474, 0),
  (480, '0000-00-00 00:00:00', '(150106) Обработка металлов давлением', 474, 0),
  (481, '0000-00-00 00:00:00', '(150107) Металлургия сварочного производства', 474, 0),
  (482, '0000-00-00 00:00:00', '(150108) Порошковая металлургия, композиционные материалы, покрытия', 474, 0),
  (483, '0000-00-00 00:00:00', '(150109) Металлургия техногенных и вторичных ресурсов', 474, 0),
  (484, '0000-00-00 00:00:00', '(150110) Контроль качества металлов и сварных соединений', 474, 0),
  (485, '0000-00-00 00:00:00', '(150200) Машиностроительные технологии и оборудование', 473, 1),
  (486, '0000-00-00 00:00:00', '(150201) Машины и технология обработки металлов давлением', 485, 0),
  (487, '0000-00-00 00:00:00', '(150202) Оборудование и технология сварочного производства', 485, 0),
  (488, '0000-00-00 00:00:00', '(150203) Сварочное производство', 485, 0),
  (489, '0000-00-00 00:00:00', '(150204) Машины и технология литейного производства', 485, 0),
  (490, '0000-00-00 00:00:00', '(150205) Оборудование и технология повышения износостойкости и восстановление деталей машин и аппаратов', 485, 0),
  (491, '0000-00-00 00:00:00', '(150206) Машины и технология высокоэффективных процессов обработки материалов', 485, 0),
  (492, '0000-00-00 00:00:00', '(150207) Реновация средств и объектов материального производства в машиностроении', 485, 0),
  (493, '0000-00-00 00:00:00', '(150300) Прикладная механика', 473, 1),
  (494, '0000-00-00 00:00:00', '(150301) Динамика и прочность машин', 493, 0),
  (495, '0000-00-00 00:00:00', '(150302) Триботехника', 493, 0),
  (496, '0000-00-00 00:00:00', '(150400) Технологические машины и оборудование', 473, 1),
  (497, '0000-00-00 00:00:00', '(150401) Проектирование технических и технологических комплексов', 496, 0),
  (498, '0000-00-00 00:00:00', '(150402) Горные машины и оборудование', 496, 0),
  (499, '0000-00-00 00:00:00', '(150403) Технологические машины и оборудование для разработки торфяных месторождений', 496, 0),
  (500, '0000-00-00 00:00:00', '(150404) Металлургические машины и оборудование', 496, 0),
  (501, '0000-00-00 00:00:00', '(150405) Машины и оборудование лесного комплекса', 496, 0),
  (502, '0000-00-00 00:00:00', '(150406) Машины и аппараты текстильной и легкой промышленности', 496, 0),
  (503, '0000-00-00 00:00:00', '(150407) Полиграфические машины и автоматизированные комплексы', 496, 0),
  (504, '0000-00-00 00:00:00', '(150408) Бытовые машины и приборы', 496, 0),
  (505, '0000-00-00 00:00:00', '(150409) Специальные машины и устройства', 496, 0),
  (506, '0000-00-00 00:00:00', '(150410) Производство изделий на автоматических роторных и роторно-конвейерных линиях', 496, 0),
  (507, '0000-00-00 00:00:00', '(150411) Монтаж и техническая эксплуатация промышленного оборудования (по отраслям)', 496, 0),
  (508, '0000-00-00 00:00:00', '(150412) Техническая эксплуатация оборудования для производства электронной техники', 496, 0),
  (509, '0000-00-00 00:00:00', '(150413) Техническая эксплуатация оборудования в торговле и общественном питании', 496, 0),
  (510, '0000-00-00 00:00:00', '(150414) Монтаж и техническая эксплуатация холодильно-компрессорных машин и установок', 496, 0),
  (511, '0000-00-00 00:00:00', '(150500) Материаловедение, технология материалов и покрытий', 473, 1),
  (512, '0000-00-00 00:00:00', '(150501) Материаловедение в машиностроении', 511, 0),
  (513, '0000-00-00 00:00:00', '(150502) Конструирование и производство изделий из композиционных материалов', 511, 0),
  (514, '0000-00-00 00:00:00', '(150600) Материаловедение и технология новых материалов', 473, 1),
  (515, '0000-00-00 00:00:00', '(150601) Материаловедение и технология новых материалов', 514, 0),
  (516, '0000-00-00 00:00:00', '(150700) Физическое материаловедение', 473, 1),
  (517, '0000-00-00 00:00:00', '(150701) Физико-химия процессов и материалов', 516, 0),
  (518, '0000-00-00 00:00:00', '(150702) Физика металлов', 516, 0),
  (519, '0000-00-00 00:00:00', '(150800) Гидравлическая, вакуумная и компрессорная техника', 473, 1),
  (520, '0000-00-00 00:00:00', '(150801) Вакуумная и компрессорная техника физических установок', 519, 0),
  (521, '0000-00-00 00:00:00', '(150802) Гидравлические машины, гидроприводы и гидропневмоавтоматика', 519, 0),
  (522, '0000-00-00 00:00:00', '(150803) Техническая эксплуатация гидравлических машин, гидроприводов и гидропневмоавтоматики', 519, 0),
  (523, '0000-00-00 00:00:00', '(150900) Технология, оборудование и автоматизация машиностроительных производств', 473, 0),
  (524, '0000-00-00 00:00:00', '(151000) Конструкторско-технологическое обеспечение автоматизированных машиностроительных производств', 473, 1),
  (525, '0000-00-00 00:00:00', '(151001) Технология машиностроения', 524, 0),
  (526, '0000-00-00 00:00:00', '(151002) Металлообрабатывающие станки и комплексы', 524, 0),
  (527, '0000-00-00 00:00:00', '(151003) Инструментальные системы машиностроительных производств', 524, 0),
  (528, '0000-00-00 00:00:00', '(160000) АВИАЦИОННАЯ И РАКЕТНО-КОСМИЧЕСКАЯ ТЕХНИКА', 1000, 1),
  (529, '0000-00-00 00:00:00', '(160100) Авиаи ракетостроение', 528, 0),
  (530, '0000-00-00 00:00:00', '(160200) Авиастроение', 528, 1),
  (531, '0000-00-00 00:00:00', '(160201) Самолетои вертолетостроение', 530, 0),
  (532, '0000-00-00 00:00:00', '(160202) Системы жизнеобеспечения оборудования летательных аппаратов', 530, 0),
  (533, '0000-00-00 00:00:00', '(160203) Производство летательных аппаратов', 530, 0),
  (534, '0000-00-00 00:00:00', '(160300) Двигатели летательных аппаратов', 528, 1),
  (535, '0000-00-00 00:00:00', '(160301) Авиационные двигатели и энергетические установки', 534, 0),
  (536, '0000-00-00 00:00:00', '(160302) Ракетные двигатели', 534, 0),
  (537, '0000-00-00 00:00:00', '(160303) Электроракетные двигатели и энергетические установки', 534, 0),
  (538, '0000-00-00 00:00:00', '(160304) Авиационная и ракетно-космическая теплотехника', 534, 0),
  (539, '0000-00-00 00:00:00', '(160305) Производство авиационных двигателей', 534, 0),
  (540, '0000-00-00 00:00:00', '(160400) Системы управления движением и навигация', 528, 1),
  (541, '0000-00-00 00:00:00', '(160401) Управляющие, пилотажно-навигационные и электроэнергетические комплексы летательных аппаратов', 540, 0),
  (542, '0000-00-00 00:00:00', '(160402) Приборы и системы ориентации, стабилизации и навигации', 540, 0),
  (543, '0000-00-00 00:00:00', '(160403) Системы управления летательными аппаратами', 540, 0),
  (544, '0000-00-00 00:00:00', '(160500) Аэронавигация', 528, 1),
  (545, '0000-00-00 00:00:00', '(160501) Эксплуатация воздушных судов и организация воздушного движения', 544, 0),
  (546, '0000-00-00 00:00:00', '(160502) Управление движением воздушного транспорта', 544, 0),
  (547, '0000-00-00 00:00:00', '(160503) Летная эксплуатация воздушных судов', 544, 0),
  (548, '0000-00-00 00:00:00', '(160504) Летная эксплуатация летательных аппаратов', 544, 0),
  (549, '0000-00-00 00:00:00', '(160505) Аэронавигационное обслуживание и использование воздушного пространства', 544, 0),
  (550, '0000-00-00 00:00:00', '(160600) Интегрированные системы летательных аппаратов', 528, 1),
  (551, '0000-00-00 00:00:00', '(160601) Прицельно-навигационные системы летательных аппаратов', 550, 0),
  (552, '0000-00-00 00:00:00', '(160602) Автоматизированные системы управления боевыми авиационными комплексами', 550, 0),
  (553, '0000-00-00 00:00:00', '(160603) Системы приводов летательных аппаратов', 550, 0),
  (554, '0000-00-00 00:00:00', '(160604) Робототехнические системы авиационного вооружения', 550, 0),
  (555, '0000-00-00 00:00:00', '(160700) Гидроаэродинамика и динамика полета', 528, 1),
  (556, '0000-00-00 00:00:00', '(160701) Баллистика', 555, 0),
  (557, '0000-00-00 00:00:00', '(160702) Гидроаэродинамика', 555, 0),
  (558, '0000-00-00 00:00:00', '(160703) Динамика полета и управление движением летательных аппаратов', 555, 0),
  (559, '0000-00-00 00:00:00', '(160800) Ракетостроение и космонавтика', 528, 1),
  (560, '0000-00-00 00:00:00', '(160801) Ракетостроение', 559, 0),
  (561, '0000-00-00 00:00:00', '(160802) Космические летательные аппараты и разгонные блоки', 559, 0),
  (562, '0000-00-00 00:00:00', '(160803) Стартовые и технические комплексы ракет и космических аппаратов', 559, 0),
  (563, '0000-00-00 00:00:00', '(160804) Системы жизнеобеспечения и защиты ракетно-космических аппаратов', 559, 0),
  (564, '0000-00-00 00:00:00', '(160900) Эксплуатация и испытания авиационной и космической техники', 528, 1),
  (565, '0000-00-00 00:00:00', '(160901) Техническая эксплуатация летательных аппаратов и двигателей', 564, 0),
  (566, '0000-00-00 00:00:00', '(160902) Обслуживание летательных аппаратов горюче-смазочными материалами', 564, 0),
  (567, '0000-00-00 00:00:00', '(160903) Техническая эксплуатация авиационных электросистем и пилотажно-навигационных комплексов', 564, 0),
  (568, '0000-00-00 00:00:00', '(160904) Техническая эксплуатация электрифицированных и пилотажно-навигационных комплексов', 564, 0),
  (569, '0000-00-00 00:00:00', '(160905) Техническая эксплуатация транспортного радиооборудования', 564, 0),
  (570, '0000-00-00 00:00:00', '(160906) Испытание летательных аппаратов', 564, 0),
  (571, '0000-00-00 00:00:00', '(170000) ОРУЖИЕ И СИСТЕМЫ ВООРУЖЕНИЯ', 1000, 1),
  (572, '0000-00-00 00:00:00', '(170100) Оружие и системы вооружения', 571, 1),
  (573, '0000-00-00 00:00:00', '(170101) Испытание и эксплуатация техники (по областям и видам)', 572, 0),
  (574, '0000-00-00 00:00:00', '(170102) Стрелково-пушечное, артиллерийское и ракетное оружие', 572, 0),
  (575, '0000-00-00 00:00:00', '(170103) Средства поражения и боеприпасы', 572, 0),
  (576, '0000-00-00 00:00:00', '(170104) Высокоэнергетические устройства автоматических систем', 572, 0),
  (577, '0000-00-00 00:00:00', '(170105) Взрыватели и системы управления средствами поражения', 572, 0),
  (578, '0000-00-00 00:00:00', '(180000) МОРСКАЯ ТЕХНИКА', 1000, 1),
  (579, '0000-00-00 00:00:00', '(180100) Кораблестроение и океанотехника', 578, 1),
  (580, '0000-00-00 00:00:00', '(180101) Кораблестроение', 579, 0),
  (581, '0000-00-00 00:00:00', '(180102) Судостроение', 579, 0),
  (582, '0000-00-00 00:00:00', '(180103) Судовые энергетические установки', 579, 0),
  (583, '0000-00-00 00:00:00', '(180104) Судовое оборудование', 579, 0),
  (584, '0000-00-00 00:00:00', '(180105) Техническая эксплуатация судов и судового оборудования', 579, 0),
  (585, '0000-00-00 00:00:00', '(180106) Океанотехника', 579, 0),
  (586, '0000-00-00 00:00:00', '(180200) Системы объектов морской инфраструктуры', 578, 1),
  (587, '0000-00-00 00:00:00', '(180201) Системы электроэнергетики и автоматизации судов', 586, 0),
  (588, '0000-00-00 00:00:00', '(180202) Системотехника объектов морской инфраструктуры', 586, 0),
  (589, '0000-00-00 00:00:00', '(180300) Корабельное вооружение', 578, 1),
  (590, '0000-00-00 00:00:00', '(180301) Морская акустика и гидрофизика', 589, 0),
  (591, '0000-00-00 00:00:00', '(180302) Подводная техника', 589, 0),
  (592, '0000-00-00 00:00:00', '(180303) Автоматические системы управления морской техникой', 589, 0),
  (593, '0000-00-00 00:00:00', '(180304) Морские информационные системы и оборудование', 589, 0),
  (594, '0000-00-00 00:00:00', '(180305) Корабельные автоматизированные комплексы и информационно-управляющие системы', 589, 0),
  (595, '0000-00-00 00:00:00', '(180400) Эксплуатация водного транспорта и транспортного оборудования', 578, 1),
  (596, '0000-00-00 00:00:00', '(180401) Гидрография и навигационное обеспечение судоходства', 595, 0),
  (597, '0000-00-00 00:00:00', '(180402) Судовождение', 595, 0),
  (598, '0000-00-00 00:00:00', '(180403) Эксплуатация судовых энергетических установок', 595, 0),
  (599, '0000-00-00 00:00:00', '(180404) Эксплуатация судового электрооборудования и средств автоматики', 595, 0),
  (600, '0000-00-00 00:00:00', '(180405) Монтаж и техническое обслуживание судовых машин и механизмов', 595, 0),
  (601, '0000-00-00 00:00:00', '(180406) Морское судовождение', 595, 0),
  (602, '0000-00-00 00:00:00', '(180407) Судовождение и эксплуатация технического флота', 595, 0),
  (603, '0000-00-00 00:00:00', '(180408) Судовождение на внутренних водных путях и в прибрежном плавании', 595, 0),
  (604, '0000-00-00 00:00:00', '(180409) Эксплуатация внутренних водных путей', 595, 0),
  (605, '0000-00-00 00:00:00', '(190000) ТРАНСПОРТНЫЕ СРЕДСТВА', 1000, 1),
  (606, '0000-00-00 00:00:00', '(190100) Наземные транспортные системы', 605, 0),
  (607, '0000-00-00 00:00:00', '(190200) Транспортные машины и транспортно-технологические комплексы', 605, 1),
  (608, '0000-00-00 00:00:00', '(190201) Автомобилеи тракторостроение', 607, 0),
  (609, '0000-00-00 00:00:00', '(190202) Многоцелевые гусеничные и колесные машины', 607, 0),
  (610, '0000-00-00 00:00:00', '(190203) Транспортные комплексы ракетной техники', 607, 0),
  (611, '0000-00-00 00:00:00', '(190204) Средства аэродромно-технического обеспечения полетов авиации', 607, 0),
  (612, '0000-00-00 00:00:00', '(190205) Подъемно-транспортные, строительные, дорожные машины и оборудование', 607, 0),
  (613, '0000-00-00 00:00:00', '(190206) Сельскохозяйственные машины и оборудование', 607, 0),
  (614, '0000-00-00 00:00:00', '(190207) Машины и оборудование природообустройства и защиты окружающей среды', 607, 0),
  (615, '0000-00-00 00:00:00', '(190300) Подвижной состав железных дорог', 605, 1),
  (616, '0000-00-00 00:00:00', '(190301) Локомотивы', 615, 0),
  (617, '0000-00-00 00:00:00', '(190302) Вагоны', 615, 0),
  (618, '0000-00-00 00:00:00', '(190303) Электрический транспорт железных дорог', 615, 0),
  (619, '0000-00-00 00:00:00', '(190304) Техническая эксплуатация подвижного состава железных дорог', 615, 0),
  (620, '0000-00-00 00:00:00', '(190400) Системы обеспечения движения поездов', 605, 1),
  (621, '0000-00-00 00:00:00', '(190401) Электроснабжение железных дорог', 620, 0),
  (622, '0000-00-00 00:00:00', '(190402) Автоматика, телемеханика и связь на железнодорожном транспорте', 620, 0),
  (623, '0000-00-00 00:00:00', '(190500) Эксплуатация транспортных средств', 605, 1),
  (624, '0000-00-00 00:00:00', '(190501) Эксплуатация транспортного электрооборудования и автоматики (по видам транспорта)', 623, 0),
  (625, '0000-00-00 00:00:00', '(190502) Эксплуатация транспортных энергетических установок (по видам транспорта)', 623, 0),
  (626, '0000-00-00 00:00:00', '(190600) Эксплуатация наземного транспорта и транспортного оборудования', 605, 1),
  (627, '0000-00-00 00:00:00', '(190601) Автомобили и автомобильное хозяйство', 626, 0),
  (628, '0000-00-00 00:00:00', '(190602) Эксплуатация перегрузочного оборудования портов и транспортных терминалов', 626, 0),
  (629, '0000-00-00 00:00:00', '(190603) Сервис транспортных и технологических машин и оборудования (по отраслям)', 626, 0),
  (630, '0000-00-00 00:00:00', '(190604) Техническое обслуживание и ремонт автомобильного транспорта', 626, 0),
  (631, '0000-00-00 00:00:00', '(190605) Техническая эксплуатация подъемно-транспортных, строительных, дорожных машин и оборудования (по отраслям)', 626, 0),
  (632, '0000-00-00 00:00:00', '(190700) Организация перевозок и управление на транспорте', 605, 1),
  (633, '0000-00-00 00:00:00', '(190701) Организация перевозок и управление на транспорте (по видам)', 632, 0),
  (634, '0000-00-00 00:00:00', '(190702) Организация и безопасность движения', 632, 0),
  (635, '0000-00-00 00:00:00', '(200000) ПРИБОРОСТРОЕНИЕ И ОПТОТЕХНИКА', 1000, 1),
  (636, '0000-00-00 00:00:00', '(200100) Приборостроение', 635, 1),
  (637, '0000-00-00 00:00:00', '(200101) Приборостроение', 636, 0),
  (638, '0000-00-00 00:00:00', '(200102) Приборы и методы контроля качества и диагностики', 636, 0),
  (639, '0000-00-00 00:00:00', '(200103) Авиационные приборы и измерительно-вычислительные комплексы', 636, 0),
  (640, '0000-00-00 00:00:00', '(200104) Авиационные приборы и комплексы', 636, 0),
  (641, '0000-00-00 00:00:00', '(200105) Акустические приборы и системы', 636, 0),
  (642, '0000-00-00 00:00:00', '(200106) Информационно-измерительная техника и технологии', 636, 0),
  (643, '0000-00-00 00:00:00', '(200107) Технология приборостроения', 636, 0),
  (644, '0000-00-00 00:00:00', '(200108) Радиоэлектронные приборные устройства', 636, 0),
  (645, '0000-00-00 00:00:00', '(200109) Электромеханические приборные устройства', 636, 0),
  (646, '0000-00-00 00:00:00', '(200200) Оптотехника', 635, 1),
  (647, '0000-00-00 00:00:00', '(200201) Лазерная техника и лазерные технологии', 646, 0),
  (648, '0000-00-00 00:00:00', '(200202) Лазерные системы в ракетной технике и космонавтике', 646, 0),
  (649, '0000-00-00 00:00:00', '(200203) Оптико-электронные приборы и системы', 646, 0),
  (650, '0000-00-00 00:00:00', '(200204) Оптические технологии и материалы', 646, 0),
  (651, '0000-00-00 00:00:00', '(200205) Оптические и оптико-электронные приборы и системы', 646, 0),
  (652, '0000-00-00 00:00:00', '(200206) Приборы и системы лучевой энергетики', 646, 0),
  (653, '0000-00-00 00:00:00', '(200300) Биомедицинская инженерия', 635, 0),
  (654, '0000-00-00 00:00:00', '(200400) Биомедицинская техника', 635, 1),
  (655, '0000-00-00 00:00:00', '(200401) Биотехнические и медицинские аппараты и системы', 654, 0),
  (656, '0000-00-00 00:00:00', '(200402) Инженерное дело в медико-биологической практике', 654, 0),
  (657, '0000-00-00 00:00:00', '(200403) Монтаж, техническое обслуживание и ремонт медицинской техники', 654, 0),
  (658, '0000-00-00 00:00:00', '(200404) Протезно-ортопедическая и реабилитационная техника', 654, 0),
  (659, '0000-00-00 00:00:00', '(200500) Метрология, стандартизация и сертификация', 635, 1),
  (660, '0000-00-00 00:00:00', '(200501) Метрология и метрологическое обеспечение', 659, 0),
  (661, '0000-00-00 00:00:00', '(200502) Метрология', 659, 0),
  (662, '0000-00-00 00:00:00', '(200503) Стандартизация и сертификация', 659, 0),
  (663, '0000-00-00 00:00:00', '(200504) Стандартизация и сертификация продукции (по отраслям)', 659, 0),
  (664, '0000-00-00 00:00:00', '(200600) Фотоника и оптоинформатика', 635, 0),
  (665, '0000-00-00 00:00:00', '(210000) ЭЛЕКТРОННАЯ ТЕХНИКА, РАДИОТЕХНИКА И СВЯЗЬ', 1000, 1),
  (666, '0000-00-00 00:00:00', '(210100) Электроника и микроэлектроника', 665, 1),
  (667, '0000-00-00 00:00:00', '(210101) Физическая электроника', 666, 0),
  (668, '0000-00-00 00:00:00', '(210102) Светотехника и источники света', 666, 0),
  (669, '0000-00-00 00:00:00', '(210103) Квантовая и оптическая электроника', 666, 0),
  (670, '0000-00-00 00:00:00', '(210104) Микроэлектроника и твердотельная электроника', 666, 0),
  (671, '0000-00-00 00:00:00', '(210105) Электронные приборы и устройства', 666, 0),
  (672, '0000-00-00 00:00:00', '(210106) Промышленная электроника', 666, 0),
  (673, '0000-00-00 00:00:00', '(210107) Электронное машиностроение', 666, 0),
  (674, '0000-00-00 00:00:00', '(210108) Микросистемная техника', 666, 0),
  (675, '0000-00-00 00:00:00', '(210200) Проектирование и технология электронных средств', 665, 1),
  (676, '0000-00-00 00:00:00', '(210201) Проектирование и технология радиоэлектронных средств', 675, 0),
  (677, '0000-00-00 00:00:00', '(210202) Проектирование и технология электронно-вычислительных средств', 675, 0),
  (678, '0000-00-00 00:00:00', '(210300) Радиотехника', 665, 1),
  (679, '0000-00-00 00:00:00', '(210301) Радиофизика и электроника', 678, 0),
  (680, '0000-00-00 00:00:00', '(210302) Радиотехника', 678, 0),
  (681, '0000-00-00 00:00:00', '(210303) Бытовая радиоэлектронная аппаратура', 678, 0),
  (682, '0000-00-00 00:00:00', '(210304) Радиоэлектронные системы', 678, 0),
  (683, '0000-00-00 00:00:00', '(210305) Средства радиоэлектронной борьбы', 678, 0),
  (684, '0000-00-00 00:00:00', '(210306) Радиоаппаратостроение', 678, 0),
  (685, '0000-00-00 00:00:00', '(210307) Эксплуатация метеорологических радиотехнических систем', 678, 0),
  (686, '0000-00-00 00:00:00', '(210308) Техническое обслуживание и ремонт радиоэлектронной техники (по отраслям)', 678, 0),
  (687, '0000-00-00 00:00:00', '(210309) Эксплуатация оборудования радиосвязи и электрорадионавигации судов', 678, 0),
  (688, '0000-00-00 00:00:00', '(210310) Радиотехнические комплексы и системы управления космических летательных аппаратов', 678, 0),
  (689, '0000-00-00 00:00:00', '(210311) Техническая эксплуатация транспортного радиоэлектронного оборудования (по видам транспорта)', 678, 0),
  (690, '0000-00-00 00:00:00', '(210312) Аудиовизуальная техника', 678, 0),
  (691, '0000-00-00 00:00:00', '(210313) Аудиовизуальная техника и звукотехническое обеспечение аудиовизуальных программ', 678, 0),
  (692, '0000-00-00 00:00:00', '(210400) Телекоммуникации', 665, 1),
  (693, '0000-00-00 00:00:00', '(210401) Физика и техника оптической связи', 692, 0),
  (694, '0000-00-00 00:00:00', '(210402) Средства связи с подвижными объектами', 692, 0),
  (695, '0000-00-00 00:00:00', '(210403) Защищенные системы связи', 692, 0),
  (696, '0000-00-00 00:00:00', '(210404) Многоканальные телекоммуникационные системы', 692, 0),
  (697, '0000-00-00 00:00:00', '(210405) Радиосвязь, радиовещание и телевидение', 692, 0),
  (698, '0000-00-00 00:00:00', '(210406) Сети связи и системы коммутации', 692, 0),
  (699, '0000-00-00 00:00:00', '(210407) Эксплуатация средств связи', 692, 0),
  (700, '0000-00-00 00:00:00', '(210500) Почтовая связь', 665, 1),
  (701, '0000-00-00 00:00:00', '(210501) Почтовая связь', 700, 0),
  (702, '0000-00-00 00:00:00', '(210600) Нанотехнология', 665, 1),
  (703, '0000-00-00 00:00:00', '(210601) Нанотехнология в электронике', 702, 0),
  (704, '0000-00-00 00:00:00', '(210602) Наноматериалы', 702, 0),
  (705, '0000-00-00 00:00:00', '(220000) АВТОМАТИКА И УПРАВЛЕНИЕ', 1000, 1),
  (706, '0000-00-00 00:00:00', '(220100) Системный анализ и управление', 705, 1),
  (707, '0000-00-00 00:00:00', '(220101) Эргономика', 706, 0),
  (708, '0000-00-00 00:00:00', '(220200) Автоматизация и управление', 705, 1),
  (709, '0000-00-00 00:00:00', '(220201) Управление и информатика в технических системах', 708, 0),
  (710, '0000-00-00 00:00:00', '(220202) Корабельные системы управления', 708, 0),
  (711, '0000-00-00 00:00:00', '(220203) Автономные информационные и управляющие системы', 708, 0),
  (712, '0000-00-00 00:00:00', '(220204) Автоматика и телемеханика на транспорте (по видам транспорта)', 708, 0),
  (713, '0000-00-00 00:00:00', '(220205) Автоматические системы управления', 708, 0),
  (714, '0000-00-00 00:00:00', '(220300) Автоматизированные технологии и производства', 705, 1),
  (715, '0000-00-00 00:00:00', '(220301) Автоматизация технологических процессов и производств (по отраслям)', 714, 0),
  (716, '0000-00-00 00:00:00', '(220302) Автоматизация технологических процессов на тепловых электрических станциях', 714, 0),
  (717, '0000-00-00 00:00:00', '(220303) Средства механизации и автоматизации (по отраслям)', 714, 0),
  (718, '0000-00-00 00:00:00', '(220304) Системы и средства диспетчерского управления в электроэнергетике', 714, 0),
  (719, '0000-00-00 00:00:00', '(220305) Автоматизированное управление жизненным циклом продукции', 714, 0),
  (720, '0000-00-00 00:00:00', '(220306) Компьютерные системы управления качеством для автоматизированных производств', 714, 0),
  (721, '0000-00-00 00:00:00', '(220400) Мехатроника и робототехника', 705, 1),
  (722, '0000-00-00 00:00:00', '(220401) Мехатроника', 721, 0),
  (723, '0000-00-00 00:00:00', '(220402) Роботы и робототехнические системы', 721, 0),
  (724, '0000-00-00 00:00:00', '(220500) Управление качеством', 705, 1),
  (725, '0000-00-00 00:00:00', '(220501) Управление качеством', 724, 0),
  (726, '0000-00-00 00:00:00', '(220600) Инноватика', 705, 1),
  (727, '0000-00-00 00:00:00', '(220601) Управление инновациями', 726, 0),
  (728, '0000-00-00 00:00:00', '(220700) Организация и управление наукоемкими производствами', 705, 1),
  (729, '0000-00-00 00:00:00', '(220701) Менеджмент высоких технологий', 728, 0),
  (730, '0000-00-00 00:00:00', '(230000) ИНФОРМАТИКА И ВЫЧИСЛИТЕЛЬНАЯ ТЕХНИКА', 1000, 1),
  (731, '0000-00-00 00:00:00', '(230100) Информатика и вычислительная техника', 730, 1),
  (732, '0000-00-00 00:00:00', '(230101) Вычислительные машины, комплексы, системы и сети', 731, 0),
  (733, '0000-00-00 00:00:00', '(230102) Автоматизированные системы обработки информации и управления', 731, 0),
  (734, '0000-00-00 00:00:00', '(230103) Автоматизированные системы обработки информации и управления (по отраслям)', 731, 0),
  (735, '0000-00-00 00:00:00', '(230104) Системы автоматизированного проектирования', 731, 0),
  (736, '0000-00-00 00:00:00', '(230105) Программное обеспечение вычислительной техники и автоматизированных систем', 731, 0),
  (737, '0000-00-00 00:00:00', '(230106) Техническое обслуживание средств вычислительной техники и компьютерных сетей', 731, 0),
  (738, '0000-00-00 00:00:00', '(230200) Информационные системы', 730, 1),
  (739, '0000-00-00 00:00:00', '(230201) Информационные системы и технологии', 738, 0),
  (740, '0000-00-00 00:00:00', '(230202) Информационные технологии в образовании', 738, 0),
  (741, '0000-00-00 00:00:00', '(230203) Информационные технологии в дизайне', 738, 0),
  (742, '0000-00-00 00:00:00', '(230204) Информационные технологии в медиаиндустрии', 738, 0),
  (743, '0000-00-00 00:00:00', '(230300) Организационно-технические системы', 730, 1),
  (744, '0000-00-00 00:00:00', '(230301) Моделирование и исследование операций в организационно-технических системах', 743, 0),
  (745, '0000-00-00 00:00:00', '(230400) Прикладная математика', 730, 1),
  (746, '0000-00-00 00:00:00', '(230401) Прикладная математика', 745, 0),
  (747, '0000-00-00 00:00:00', '(240000) ХИМИЧЕСКАЯ И БИОТЕХНОЛОГИИ', 1000, 1),
  (748, '0000-00-00 00:00:00', '(240100) Химическая технология и биотехнология', 747, 0),
  (749, '0000-00-00 00:00:00', '(240200) Химическая технология полимерных волокон и текстильных материалов', 747, 1),
  (750, '0000-00-00 00:00:00', '(240201) Технология и оборудование производства химических волокон и композиционных материалов на их основе', 749, 0),
  (751, '0000-00-00 00:00:00', '(240202) Химическая технология и оборудование отделочного производства', 749, 0),
  (752, '0000-00-00 00:00:00', '(240203) Химическая технология отделочного производства', 749, 0),
  (753, '0000-00-00 00:00:00', '(240300) Химическая технология неорганических веществ и материалов', 747, 1),
  (754, '0000-00-00 00:00:00', '(240301) Химическая технология неорганических веществ', 753, 0),
  (755, '0000-00-00 00:00:00', '(240302) Технология электрохимических производств', 753, 0),
  (756, '0000-00-00 00:00:00', '(240303) Электрохимическое производство', 753, 0),
  (757, '0000-00-00 00:00:00', '(240304) Химическая технология тугоплавких неметаллических и силикатных материалов', 753, 0),
  (758, '0000-00-00 00:00:00', '(240305) Производство тугоплавких неметаллических и силикатных материалов и изделий', 753, 0),
  (759, '0000-00-00 00:00:00', '(240306) Химическая технология монокристаллов, материалов и изделий электронной техники', 753, 0),
  (760, '0000-00-00 00:00:00', '(240307) Технология средств химической защиты', 753, 0),
  (761, '0000-00-00 00:00:00', '(240308) Аналитический контроль качества химических соединений', 753, 0),
  (762, '0000-00-00 00:00:00', '(240400) Химическая технология органических веществ и топлива', 747, 1),
  (763, '0000-00-00 00:00:00', '(240401) Химическая технология органических веществ', 762, 0),
  (764, '0000-00-00 00:00:00', '(240402) Химическая технология синтетических биологических активных веществ', 762, 0),
  (765, '0000-00-00 00:00:00', '(240403) Химическая технология природных энергоносителей и углеродных материалов', 762, 0),
  (766, '0000-00-00 00:00:00', '(240404) Переработка нефти и газа', 762, 0),
  (767, '0000-00-00 00:00:00', '(240405) Коксохимическое производство', 762, 0),
  (768, '0000-00-00 00:00:00', '(240406) Технология химической переработки древесины', 762, 0),
  (769, '0000-00-00 00:00:00', '(240500) Химическая технология высокомолекулярных соединений и полимерных материалов', 747, 1),
  (770, '0000-00-00 00:00:00', '(240501) Химическая технология высокомолекулярных соединений', 769, 0),
  (771, '0000-00-00 00:00:00', '(240502) Технология переработки пластических масс и эластомеров', 769, 0),
  (772, '0000-00-00 00:00:00', '(240503) Производство изделий и покрытий из полимерных материалов', 769, 0),
  (773, '0000-00-00 00:00:00', '(240504) Технология кинофотоматериалов и магнитных носителей', 769, 0),
  (774, '0000-00-00 00:00:00', '(240505) Технология высокомолекулярных и высокоэффективных соединений и устройств', 769, 0),
  (775, '0000-00-00 00:00:00', '(240600) Химическая технология материалов современной энергетики', 747, 1),
  (776, '0000-00-00 00:00:00', '(240601) Химическая технология материалов современной энергетики', 775, 0),
  (777, '0000-00-00 00:00:00', '(240602) Технология разделения изотопов', 775, 0),
  (778, '0000-00-00 00:00:00', '(240603) Химическая технология редких элементов и материалов на их основе', 775, 0),
  (779, '0000-00-00 00:00:00', '(240700) Химическая технология энергонасыщенных материалов и изделий', 747, 1),
  (780, '0000-00-00 00:00:00', '(240701) Химическая технология органических соединений азота', 779, 0),
  (781, '0000-00-00 00:00:00', '(240702) Химическая технология полимерных композиций, порохов и твердых ракетных топлив', 779, 0),
  (782, '0000-00-00 00:00:00', '(240703) Технология энергонасыщенных материалов и изделий', 779, 0),
  (783, '0000-00-00 00:00:00', '(240704) Технология пиротехнических средств', 779, 0),
  (784, '0000-00-00 00:00:00', '(240705) Технология пиротехнических составов и изделий', 779, 0),
  (785, '0000-00-00 00:00:00', '(240706) Автоматизированное производство химических предприятий', 779, 0),
  (786, '0000-00-00 00:00:00', '(240800) Энергои ресурсосберегающие процессы в химической технологии, нефтехимии и биотехнологии', 747, 1),
  (787, '0000-00-00 00:00:00', '(240801) Машины и аппараты химических производств', 786, 0),
  (788, '0000-00-00 00:00:00', '(240802) Основные процессы химических производств и химическая кибернетика', 786, 0),
  (789, '0000-00-00 00:00:00', '(240803) Рациональное использование материальных и энергетических ресурсов', 786, 0),
  (790, '0000-00-00 00:00:00', '(240900) Биотехнология', 747, 1),
  (791, '0000-00-00 00:00:00', '(240901) Биотехнология', 790, 0),
  (792, '0000-00-00 00:00:00', '(240902) Пищевая биотехнология', 790, 0),
  (793, '0000-00-00 00:00:00', '(240903) Биохимическое производство', 790, 0),
  (794, '0000-00-00 00:00:00', '(250000) ВОСПРОИЗВОДСТВО И ПЕРЕРАБОТКА ЛЕСНЫХ РЕСУРСОВ', 1000, 1),
  (795, '0000-00-00 00:00:00', '(250100) Лесное дело', 794, 0),
  (796, '0000-00-00 00:00:00', '(250200) Лесное хозяйство и ландшафтное строительство', 794, 1),
  (797, '0000-00-00 00:00:00', '(250201) Лесное хозяйство', 796, 0),
  (798, '0000-00-00 00:00:00', '(250202) Лесное и лесопарковое хозяйство', 796, 0),
  (799, '0000-00-00 00:00:00', '(250203) Садово-парковое и ландшафтное строительство', 796, 0),
  (800, '0000-00-00 00:00:00', '(250300) Технология и оборудование лесозаготовительных и деревообрабатывающих производств', 794, 0),
  (801, '0000-00-00 00:00:00', '(250400) Технология лесозаготовительных и деревоперерабатывающих производств', 794, 1),
  (802, '0000-00-00 00:00:00', '(250401) Лесоинженерное дело', 801, 0),
  (803, '0000-00-00 00:00:00', '(250402) Технология лесозаготовок', 801, 0),
  (804, '0000-00-00 00:00:00', '(250403) Технология деревообработки', 801, 0),
  (805, '0000-00-00 00:00:00', '(250404) Технология переработки древесины', 801, 0),
  (806, '0000-00-00 00:00:00', '(260000) ТЕХНОЛОГИЯ ПРОДОВОЛЬСТВЕННЫХ ПРОДУКТОВ И ПОТРЕБИТЕЛЬСКИХ ТОВАРОВ', 1000, 1),
  (807, '0000-00-00 00:00:00', '(260100) Технология продуктов питания', 806, 0),
  (808, '0000-00-00 00:00:00', '(260200) Производство продуктов питания из растительного сырья', 806, 1),
  (809, '0000-00-00 00:00:00', '(260201) Технология хранения и переработки зерна', 808, 0),
  (810, '0000-00-00 00:00:00', '(260202) Технология хлеба, кондитерских и макаронных изделий', 808, 0),
  (811, '0000-00-00 00:00:00', '(260203) Технология сахаристых продуктов', 808, 0),
  (812, '0000-00-00 00:00:00', '(260204) Технология бродильных производств и виноделие', 808, 0),
  (813, '0000-00-00 00:00:00', '(260300) Технология сырья и продуктов животного происхождения', 806, 1),
  (814, '0000-00-00 00:00:00', '(260301) Технология мяса и мясных продуктов', 813, 0),
  (815, '0000-00-00 00:00:00', '(260302) Технология рыбы и рыбных продуктов', 813, 0),
  (816, '0000-00-00 00:00:00', '(260303) Технология молока и молочных продуктов', 813, 0),
  (817, '0000-00-00 00:00:00', '(260400) Технология жиров', 806, 1),
  (818, '0000-00-00 00:00:00', '(260401) Технология жиров, эфирных масел и парфюмерно-косметических продуктов', 817, 0),
  (819, '0000-00-00 00:00:00', '(260402) Технология жиров и жирозаменителей', 817, 0),
  (820, '0000-00-00 00:00:00', '(260500) Технология продовольственных продуктов специального назначения и общественного питания', 806, 1),
  (821, '0000-00-00 00:00:00', '(260501) Технология продуктов общественного питания', 820, 0),
  (822, '0000-00-00 00:00:00', '(260502) Технология продукции общественного питания', 820, 0),
  (823, '0000-00-00 00:00:00', '(260503) Технология субтропических и пищевкусовых продуктов', 820, 0),
  (824, '0000-00-00 00:00:00', '(260504) Технология консервов и пищеконцентратов', 820, 0),
  (825, '0000-00-00 00:00:00', '(260505) Технология детского и функционального питания', 820, 0),
  (826, '0000-00-00 00:00:00', '(260600) Пищевая инженерия', 806, 1),
  (827, '0000-00-00 00:00:00', '(260601) Машины и аппараты пищевых производств', 826, 0),
  (828, '0000-00-00 00:00:00', '(260602) Пищевая инженерия малых предприятий', 826, 0),
  (829, '0000-00-00 00:00:00', '(260700) Технология и проектирование текстильных изделий', 806, 1),
  (830, '0000-00-00 00:00:00', '(260701) Технология и оборудование производства натуральных волокон', 829, 0),
  (831, '0000-00-00 00:00:00', '(260702) Первичная обработка волокнистых материалов', 829, 0),
  (832, '0000-00-00 00:00:00', '(260703) Проектирование текстильных изделий', 829, 0),
  (833, '0000-00-00 00:00:00', '(260704) Технология текстильных изделий', 829, 0),
  (834, '0000-00-00 00:00:00', '(260800) Технология, конструирование изделий и материалы легкой промышленности', 806, 0),
  (835, '0000-00-00 00:00:00', '(260900) Технология и конструирование изделий легкой промышленности', 806, 1),
  (836, '0000-00-00 00:00:00', '(260901) Технология швейных изделий', 835, 0),
  (837, '0000-00-00 00:00:00', '(260902) Конструирование швейных изделий', 835, 0),
  (838, '0000-00-00 00:00:00', '(260903) Моделирование и конструирование швейных изделий', 835, 0),
  (839, '0000-00-00 00:00:00', '(260904) Технология кожи и меха', 835, 0),
  (840, '0000-00-00 00:00:00', '(260905) Технология изделий из кожи', 835, 0),
  (841, '0000-00-00 00:00:00', '(260906) Конструирование изделий из кожи', 835, 0),
  (842, '0000-00-00 00:00:00', '(260907) Моделирование и конструирование изделий из кожи', 835, 0),
  (843, '0000-00-00 00:00:00', '(260908) Производство меховых и овчинно-шубных изделий', 835, 0),
  (844, '0000-00-00 00:00:00', '(260909) Моделирование и конструирование изделий из меха', 835, 0),
  (845, '0000-00-00 00:00:00', '(260910) Производство изделий из бумаги и картона', 835, 0),
  (846, '0000-00-00 00:00:00', '(261000) Технология художественной обработки материалов', 806, 1),
  (847, '0000-00-00 00:00:00', '(261001) Технология художественной обработки материалов', 846, 0),
  (848, '0000-00-00 00:00:00', '(261002) Технология обработки драгоценных камней и металлов', 846, 0),
  (849, '0000-00-00 00:00:00', '(261100) Полиграфия', 806, 0),
  (850, '0000-00-00 00:00:00', '(261200) Технология полиграфического и упаковочного производства', 806, 1),
  (851, '0000-00-00 00:00:00', '(261201) Технология и дизайн упаковочного производства', 850, 0),
  (852, '0000-00-00 00:00:00', '(261202) Технология полиграфического производства', 850, 0),
  (853, '0000-00-00 00:00:00', '(261203) Полиграфическое производство', 850, 0),
  (854, '0000-00-00 00:00:00', '(261300) Экспертиза качества потребительских товаров', 806, 1),
  (855, '0000-00-00 00:00:00', '(261301) Экспертиза качества потребительских товаров', 854, 0),
  (856, '0000-00-00 00:00:00', '(270000) АРХИТЕКТУРА И СТРОИТЕЛЬСТВО', 1000, 1),
  (857, '0000-00-00 00:00:00', '(270100) Строительство', 856, 1),
  (858, '0000-00-00 00:00:00', '(270101) Механическое оборудование и технологические комплексы предприятий строительных материалов, изделий и конструкций', 857, 0),
  (859, '0000-00-00 00:00:00', '(270102) Промышленное и гражданское строительство', 857, 0),
  (860, '0000-00-00 00:00:00', '(270103) Строительство и эксплуатация зданий и сооружений', 857, 0),
  (861, '0000-00-00 00:00:00', '(270104) Гидротехническое строительство', 857, 0),
  (862, '0000-00-00 00:00:00', '(270105) Городское строительство и хозяйство', 857, 0),
  (863, '0000-00-00 00:00:00', '(270106) Производство строительных материалов, изделий и конструкций', 857, 0),
  (864, '0000-00-00 00:00:00', '(270107) Производство неметаллических строительных изделий и конструкций', 857, 0),
  (865, '0000-00-00 00:00:00', '(270108) Изготовление металлических конструкций', 857, 0),
  (866, '0000-00-00 00:00:00', '(270109) Теплогазоснабжение и вентиляция', 857, 0),
  (867, '0000-00-00 00:00:00', '(270110) Монтаж и эксплуатация внутренних сантехнических устройств и вентиляции', 857, 0),
  (868, '0000-00-00 00:00:00', '(270111) Монтаж и эксплуатация оборудования и систем газоснабжения', 857, 0),
  (869, '0000-00-00 00:00:00', '(270112) Водоснабжение и водоотведение', 857, 0),
  (870, '0000-00-00 00:00:00', '(270113) Механизация и автоматизация строительства', 857, 0),
  (871, '0000-00-00 00:00:00', '(270114) Проектирование зданий', 857, 0),
  (872, '0000-00-00 00:00:00', '(270115) Экспертиза и управление недвижимостью', 857, 0),
  (873, '0000-00-00 00:00:00', '(270116) Монтаж, наладка и эксплуатация электрооборудования промышленных и гражданских зданий', 857, 0),
  (874, '0000-00-00 00:00:00', '(270200) Транспортное строительство', 856, 1),
  (875, '0000-00-00 00:00:00', '(270201) Мосты и транспортные тоннели', 874, 0),
  (876, '0000-00-00 00:00:00', '(270202) Строительство мостов', 874, 0),
  (877, '0000-00-00 00:00:00', '(270203) Строительство тоннелей и метрополитенов', 874, 0),
  (878, '0000-00-00 00:00:00', '(270204) Строительство железных дорог, путь и путевое хозяйство', 874, 0),
  (879, '0000-00-00 00:00:00', '(270205) Автомобильные дороги и аэродромы', 874, 0),
  (880, '0000-00-00 00:00:00', '(270206) Строительство и эксплуатация автомобильных дорог и аэродромов', 874, 0),
  (881, '0000-00-00 00:00:00', '(270207) Строительство и эксплуатация городских путей сообщения', 874, 0),
  (882, '0000-00-00 00:00:00', '(270300) Архитектура', 856, 1),
  (883, '0000-00-00 00:00:00', '(270301) Архитектура', 882, 0),
  (884, '0000-00-00 00:00:00', '(270302) Дизайн архитектурной среды', 882, 0),
  (885, '0000-00-00 00:00:00', '(270303) Реставрация и реконструкция архитектурного наследия', 882, 0),
  (886, '0000-00-00 00:00:00', '(280000) БЕЗОПАСНОСТЬ ЖИЗНЕДЕЯТЕЛЬНОСТИ, ПРИРОДООБУСТРОЙСТВО И ЗАЩИТА ОКРУЖАЮЩЕЙ СРЕДЫ', 1000, 1),
  (887, '0000-00-00 00:00:00', '(280100) Безопасность жизнедеятельности', 886, 1),
  (888, '0000-00-00 00:00:00', '(280101) Безопасность жизнедеятельности в техносфере', 887, 0),
  (889, '0000-00-00 00:00:00', '(280102) Безопасность технологических процессов и производств', 887, 0),
  (890, '0000-00-00 00:00:00', '(280103) Защита в чрезвычайных ситуациях', 887, 0),
  (891, '0000-00-00 00:00:00', '(280104) Пожарная безопасность', 887, 0),
  (892, '0000-00-00 00:00:00', '(280200) Защита окружающей среды', 886, 1),
  (893, '0000-00-00 00:00:00', '(280201) Охрана окружающей среды и рациональное использование природных ресурсов', 892, 0),
  (894, '0000-00-00 00:00:00', '(280202) Инженерная защита окружающей среды', 892, 0),
  (895, '0000-00-00 00:00:00', '(280300) Водные ресурсы и водопользование', 886, 1),
  (896, '0000-00-00 00:00:00', '(280301) Инженерные системы сельскохозяйственного водоснабжения, обводнения и водоотведения', 895, 0),
  (897, '0000-00-00 00:00:00', '(280302) Комплексное использование и охрана водных ресурсов', 895, 0),
  (898, '0000-00-00 00:00:00', '(280400) Природообустройство', 886, 1),
  (899, '0000-00-00 00:00:00', '(280401) Мелиорация, рекультивация и охрана земель', 898, 0),
  (900, '0000-00-00 00:00:00', '(280402) Природоохранное обустройство территорий', 898, 0),
  (1000, '0000-00-00 00:00:00', 'СПЕЦИАЛЬНОСТИ', 0, 1);
